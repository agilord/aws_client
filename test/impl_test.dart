...
void main() {
  ...
  group('SQS-queue', (){
    ...
    test('create-queue', () async {
      ...
      final credentials = new Credentials(accessKey: accessKey, secretKey: accessSecret);
      final aws = new Aws(credentials: credentials, httpClient: httpClient);
      final queue = await aws.sqs.create(region: region, queueName:'[set your queue name]');
