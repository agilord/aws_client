...
class CloudFront {
  ...
  Future<CreateInvalidationResult> createInvalidation2017_03_25({
    ...
    final $result = await _protocol.send(
      method: 'POST',
      requestUri:
          '/2017-03-25/distribution/${Uri.encodeComponent(distributionId.toString())}/invalidation',
  ...
  Future<void> deleteCloudFrontOriginAccessIdentity2017_03_25({
    ...
    await _protocol.send(
      method: 'DELETE',
      requestUri:
          '/2017-03-25/origin-access-identity/cloudfront/${Uri.encodeComponent(id.toString())}',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
  }
  ...
  Future<void> deleteDistribution2017_03_25({
    ...
    await _protocol.send(
      method: 'DELETE',
      requestUri:
          '/2017-03-25/distribution/${Uri.encodeComponent(id.toString())}',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
  }
  ...
  Future<void> deleteServiceLinkedRole2017_03_25({
    ...
    await _protocol.send(
      method: 'DELETE',
      requestUri:
          '/2017-03-25/service-linked-role/${Uri.encodeComponent(roleName.toString())}',
      exceptionFnMap: _exceptionFns,
    );
  }
  ...
  Future<void> deleteStreamingDistribution2017_03_25({
    ...
    await _protocol.send(
      method: 'DELETE',
      requestUri:
          '/2017-03-25/streaming-distribution/${Uri.encodeComponent(id.toString())}',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
  }
  ...
  Future<GetCloudFrontOriginAccessIdentityConfigResult>
    ...
    final $result = await _protocol.send(
      method: 'GET',
      requestUri:
          '/2017-03-25/origin-access-identity/cloudfront/${Uri.encodeComponent(id.toString())}/config',
      exceptionFnMap: _exceptionFns,
    );
  ...
  Future<GetDistributionConfigResult> getDistributionConfig2017_03_25({
    ...
    final $result = await _protocol.send(
      method: 'GET',
      requestUri:
          '/2017-03-25/distribution/${Uri.encodeComponent(id.toString())}/config',
      exceptionFnMap: _exceptionFns,
    );
  ...
  Future<GetInvalidationResult> getInvalidation2017_03_25({
    ...
    final $result = await _protocol.send(
      method: 'GET',
      requestUri:
          '/2017-03-25/distribution/${Uri.encodeComponent(distributionId.toString())}/invalidation/${Uri.encodeComponent(id.toString())}',
      exceptionFnMap: _exceptionFns,
    );
  ...
  Future<GetStreamingDistributionConfigResult>
    ...
    final $result = await _protocol.send(
      method: 'GET',
      requestUri:
          '/2017-03-25/streaming-distribution/${Uri.encodeComponent(id.toString())}/config',
      exceptionFnMap: _exceptionFns,
    );
  ...
  Future<ListDistributionsByWebACLIdResult>
    ...
    final $result = await _protocol.send(
      method: 'GET',
      requestUri:
          '/2017-03-25/distributionsByWebACLId/${Uri.encodeComponent(webACLId.toString())}',
      queryParams: queryParams,
      exceptionFnMap: _exceptionFns,
    );
