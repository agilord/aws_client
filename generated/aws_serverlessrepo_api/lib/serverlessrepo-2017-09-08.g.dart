...
part of 'serverlessrepo-2017-09-08.dart';
...
ApplicationPolicyStatement _$ApplicationPolicyStatementFromJson(
  ...
  return ApplicationPolicyStatement(
    ...
    principals:
        (json['principals'] as List<dynamic>).map((e) => e as String).toList(),
    principalOrgIDs: (json['principalOrgIDs'] as List<dynamic>?)
        ?.map((e) => e as String)
        .toList(),
...
ParameterDefinition _$ParameterDefinitionFromJson(Map<String, dynamic> json) {
  return ParameterDefinition(
    name: json['name'] as String,
    referencedByResources: (json['referencedByResources'] as List<dynamic>)
        .map((e) => e as String)
        .toList(),
