...
Api _$ApiFromJson(Map<String, dynamic> json) {
  return Api(
    ...
    protocolType: _$enumDecode(_$ProtocolTypeEnumMap, json['protocolType']),
    ...
    importInfo: (json['importInfo'] as List<dynamic>?)
        ?.map((e) => e as String)
        .toList(),
...
Authorizer _$AuthorizerFromJson(Map<String, dynamic> json) {
  return Authorizer(
    ...
    identitySource: (json['identitySource'] as List<dynamic>?)
        ?.map((e) => e as String)
        .toList(),
...
CreateDomainNameResponse _$CreateDomainNameResponseFromJson(
  ...
  return CreateDomainNameResponse(
    ...
    domainNameConfigurations: (json['domainNameConfigurations']
            as List<dynamic>?)
        ?.map(
            (e) => DomainNameConfiguration.fromJson(e as Map<String, dynamic>))
        .toList(),
...
CreateRouteResult _$CreateRouteResultFromJson(Map<String, dynamic> json) {
  return CreateRouteResult(
    ...
    requestParameters:
        (json['requestParameters'] as Map<String, dynamic>?)?.map(
      (k, e) =>
          MapEntry(k, ParameterConstraints.fromJson(e as Map<String, dynamic>)),
    ),
...
CreateStageResponse _$CreateStageResponseFromJson(Map<String, dynamic> json) {
  return CreateStageResponse(
    ...
    routeSettings: (json['routeSettings'] as Map<String, dynamic>?)?.map(
      (k, e) => MapEntry(k, RouteSettings.fromJson(e as Map<String, dynamic>)),
    ),
