...
part 'networkmanager-2019-07-05.g.dart';
...
class NetworkManager {
  ...
  Future<GetDevicesResponse> getDevices({
    ...
    _query = '?${[
      ...
      if (maxResults != null) _s.toQueryParam('maxResults', maxResults),
      if (nextToken != null) _s.toQueryParam('nextToken', nextToken),
      if (siteId != null) _s.toQueryParam('siteId', siteId),
    ].where((e) => e != null).join('&')}';
    final response = await _protocol.send(
      payload: null,
      method: 'GET',
  ...
  Future<GetLinksResponse> getLinks({
    ...
    _query = '?${[
      ...
      if (maxResults != null) _s.toQueryParam('maxResults', maxResults),
      if (nextToken != null) _s.toQueryParam('nextToken', nextToken),
      if (provider != null) _s.toQueryParam('provider', provider),
      if (siteId != null) _s.toQueryParam('siteId', siteId),
  ...
  Future<GetTransitGatewayRegistrationsResponse>
    ...
    _query = '?${[
      ...
      if (transitGatewayArns != null)
        _s.toQueryParam('transitGatewayArns', transitGatewayArns),
    ].where((e) => e != null).join('&')}';
    final response = await _protocol.send(
      payload: null,
      method: 'GET',
