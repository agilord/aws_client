...
class DocDB {
  ...
  ///
  /// Parameter [copyTags] :
  /// Set to <code>true</code> to copy all tags from the source DB cluster
  ...
  /// encrypted with the same AWS KMS key as the source DB cluster snapshot.
  ///
  ...
  /// encrypt the copy of the DB cluster snapshot in the destination Region. AWS
  ...
  /// contains the source DB cluster snapshot to copy. You must use the
  ...
  /// can't be used with the <code>DBClusterIdentifier</code> parameter. This
  ...
  /// Set to <code>true</code> to include manual DB cluster snapshots that are
  /// public and can be copied or restored by any AWS account, and otherwise
  /// <code>false</code>. The default is <code>false</code>.
  ///
  /// Parameter [includeShared] :
  /// Set to <code>true</code> to include shared manual DB cluster snapshots
  /// from other AWS accounts that this AWS account has been given permission to
  /// copy or restore, and otherwise <code>false</code>. The default is
  /// <code>false</code>.
  ///
  /// Parameter [marker] :
  /// An optional pagination token provided by a previous request. If this
  ...
  /// </li>
  /// <li>
  /// <code>manual</code> - Return all DB cluster snapshots that you have
  /// manually created for your AWS account.
  /// </li>
  /// <li>
  /// <code>shared</code> - Return all manual DB cluster snapshots that have
  /// been shared to your AWS account.
  /// </li>
  /// <li>
  ...
  /// instance ARNs. The results list includes only the information about the DB
  ...
  /// <li>
  /// <code>db-instance-id</code> - Accepts DB instance identifiers and DB
  /// instance ARNs. The results list includes only pending maintenance actions
  ...
  /// <code>PreferredMaintenanceWindow</code> setting for the DB cluster. If
  ...
  /// <code>all</code>. Do not add the <code>all</code> value for any manual DB
  ...
  /// specify <code>all</code>, an AWS account whose account ID is explicitly
  /// added to the <code>restore</code> attribute can still copy or restore a
  /// manual DB cluster snapshot.
  ...
  /// <code>db.r5.large</code>. Not all DB instance classes are available in all
  /// AWS Regions.
  ///
  ...
  /// occurs immediately if you set <code>Apply Immediately</code> to
  ...
  /// current time, changing this parameter causes a reboot of the DB instance.
  ...
  /// status is set to <i>rebooting</i>.
  ///
  /// May throw [InvalidDBInstanceStateFault].
  /// May throw [DBInstanceNotFoundFault].
  ///
  ...
  /// is encrypted using the AWS KMS key that was used to encrypt the DB
...
/// values within these arrays depend on the DB engine that is being used.
...
class DBClusterRole {
  ...
  /// The <code>Status</code> property returns one of the following values:
  ///
  /// <ul>
  /// <li>
  ...
  /// but the DB cluster cannot assume the IAM role to access other AWS services
  /// on your behalf.
  /// </li>
  /// </ul>
  final String status;
...
class DBInstanceStatusInfo {
  ...
  /// Status of the DB instance. For a <code>StatusType</code> of read replica,
  /// the values can be <code>replicating</code>, error, <code>stopped</code>, or
