...
part of 'comprehend-2017-11-27.dart';
...
Map<String, dynamic> _$EndpointFilterToJson(EndpointFilter instance) {
  ...
  writeNotNull(
      'CreationTimeAfter', instance.creationTimeAfter?.toIso8601String());
  writeNotNull(
      'CreationTimeBefore', instance.creationTimeBefore?.toIso8601String());
