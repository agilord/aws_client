...
class Mobile {
  ...
  Future<DeleteProjectResult> deleteProject({
    ...
    final response = await _protocol.send(
      ...
      method: 'DELETE',
      requestUri:
          '/projects/${Uri.encodeComponent(projectId.toString())}$query',
      exceptionFnMap: _exceptionFns,
    );
  ...
  Future<DescribeBundleResult> describeBundle({
    ...
    final response = await _protocol.send(
      payload: null,
      method: 'GET',
      requestUri: '/bundles/${Uri.encodeComponent(bundleId.toString())}$query',
      exceptionFnMap: _exceptionFns,
    );
  ...
  Future<ExportProjectResult> exportProject({
    ...
    final response = await _protocol.send(
      payload: $payload,
      method: 'POST',
      requestUri: '/exports/${Uri.encodeComponent(projectId.toString())}$query',
      exceptionFnMap: _exceptionFns,
    );
