...
part of 'mobile-2017-07-01.dart';
...
DeleteProjectResult _$DeleteProjectResultFromJson(Map<String, dynamic> json) {
  return DeleteProjectResult(
    deletedResources: (json['deletedResources'] as List<dynamic>?)
        ?.map((e) => Resource.fromJson(e as Map<String, dynamic>))
        .toList(),
    orphanedResources: (json['orphanedResources'] as List<dynamic>?)
        ?.map((e) => Resource.fromJson(e as Map<String, dynamic>))
        .toList(),
  );
}
...
ListBundlesResult _$ListBundlesResultFromJson(Map<String, dynamic> json) {
  return ListBundlesResult(
    bundleList: (json['bundleList'] as List<dynamic>?)
