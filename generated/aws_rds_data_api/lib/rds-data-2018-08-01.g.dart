...
part of 'rds-data-2018-08-01.dart';
...
ArrayValue _$ArrayValueFromJson(Map<String, dynamic> json) {
  return ArrayValue(
    arrayValues: (json['arrayValues'] as List<dynamic>?)
        ?.map((e) => ArrayValue.fromJson(e as Map<String, dynamic>))
        .toList(),
    booleanValues: (json['booleanValues'] as List<dynamic>?)
        ?.map((e) => e as bool)
        .toList(),
    doubleValues: (json['doubleValues'] as List<dynamic>?)
...
ExecuteSqlResponse _$ExecuteSqlResponseFromJson(Map<String, dynamic> json) {
  return ExecuteSqlResponse(
    sqlStatementResults: (json['sqlStatementResults'] as List<dynamic>?)
...
ExecuteStatementResponse _$ExecuteStatementResponseFromJson(
  ...
  return ExecuteStatementResponse(
    columnMetadata: (json['columnMetadata'] as List<dynamic>?)
        ...
        .toList(),
    generatedFields: (json['generatedFields'] as List<dynamic>?)
...
Field _$FieldFromJson(Map<String, dynamic> json) {
  return Field(
    ...
    blobValue: const Uint8ListNullableConverter()
        .fromJson(json['blobValue'] as String?),
...
Map<String, dynamic> _$FieldToJson(Field instance) {
  ...
  writeNotNull('blobValue',
      const Uint8ListNullableConverter().toJson(instance.blobValue));
