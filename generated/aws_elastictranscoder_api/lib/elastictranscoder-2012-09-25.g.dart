...
part of 'elastictranscoder-2012-09-25.dart';
...
Captions _$CaptionsFromJson(Map<String, dynamic> json) {
  return Captions(
    captionFormats: (json['CaptionFormats'] as List<dynamic>?)
        ?.map((e) => CaptionFormat.fromJson(e as Map<String, dynamic>))
        .toList(),
    captionSources: (json['CaptionSources'] as List<dynamic>?)
...
JobAlbumArt _$JobAlbumArtFromJson(Map<String, dynamic> json) {
  return JobAlbumArt(
    artwork: (json['Artwork'] as List<dynamic>?)
...
Playlist _$PlaylistFromJson(Map<String, dynamic> json) {
  return Playlist(
    ...
    name: json['Name'] as String?,
    outputKeys: (json['OutputKeys'] as List<dynamic>?)
        ?.map((e) => e as String)
        .toList(),
