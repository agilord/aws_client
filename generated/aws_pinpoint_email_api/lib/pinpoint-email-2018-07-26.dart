...
part 'pinpoint-email-2018-07-26.g.dart';
...
/// you lose the ability to use Amazon Pinpoint to send email from that
/// identity. You can restore your ability to send email by completing the
...
class PutAccountDedicatedIpWarmupAttributesRequest {
  ...
  /// Region. Set to <code>true</code> to enable the automatic warm-up feature, or
...
class PutEmailIdentityDkimAttributesRequest {
  ...
  ///
  /// When you set this value <code>true</code>, then the messages that Amazon
  /// Pinpoint sends from the identity are DKIM-signed. When you set this value to
  /// <code>false</code>, then the messages that Amazon Pinpoint sends from the
