...
AppsListData _$AppsListDataFromJson(Map<String, dynamic> json) {
  return AppsListData(
    appsList: (json['AppsList'] as List<dynamic>)
...
AwsEc2InstanceViolation _$AwsEc2InstanceViolationFromJson(
  ...
  return AwsEc2InstanceViolation(
    awsEc2NetworkInterfaceViolations: (json['AwsEc2NetworkInterfaceViolations']
            as List<dynamic>?)
        ?.map((e) =>
            AwsEc2NetworkInterfaceViolation.fromJson(e as Map<String, dynamic>))
        .toList(),
...
AwsEc2NetworkInterfaceViolation _$AwsEc2NetworkInterfaceViolationFromJson(
  ...
  return AwsEc2NetworkInterfaceViolation(
    violatingSecurityGroups: (json['ViolatingSecurityGroups'] as List<dynamic>?)
        ?.map((e) => e as String)
        .toList(),
    violationTarget: json['ViolationTarget'] as String?,
  );
...
AwsVPCSecurityGroupViolation _$AwsVPCSecurityGroupViolationFromJson(
  ...
  return AwsVPCSecurityGroupViolation(
    partialMatches: (json['PartialMatches'] as List<dynamic>?)
        ?.map((e) => PartialMatch.fromJson(e as Map<String, dynamic>))
        .toList(),
    possibleSecurityGroupRemediationActions:
        (json['PossibleSecurityGroupRemediationActions'] as List<dynamic>?)
...
ListAppsListsResponse _$ListAppsListsResponseFromJson(
  ...
  return ListAppsListsResponse(
    appsLists: (json['AppsLists'] as List<dynamic>?)
...
ListComplianceStatusResponse _$ListComplianceStatusResponseFromJson(
  ...
  return ListComplianceStatusResponse(
    nextToken: json['NextToken'] as String?,
    policyComplianceStatusList: (json['PolicyComplianceStatusList']
            as List<dynamic>?)
        ?.map((e) => PolicyComplianceStatus.fromJson(e as Map<String, dynamic>))
        .toList(),
  );
}
...
ListProtocolsListsResponse _$ListProtocolsListsResponseFromJson(
  ...
  return ListProtocolsListsResponse(
    nextToken: json['NextToken'] as String?,
    protocolsLists: (json['ProtocolsLists'] as List<dynamic>?)
        ?.map(
            (e) => ProtocolsListDataSummary.fromJson(e as Map<String, dynamic>))
        .toList(),
  );
}
...
NetworkFirewallPolicyDescription _$NetworkFirewallPolicyDescriptionFromJson(
  ...
  return NetworkFirewallPolicyDescription(
    statefulRuleGroups: (json['StatefulRuleGroups'] as List<dynamic>?)
        ?.map((e) => StatefulRuleGroup.fromJson(e as Map<String, dynamic>))
        .toList(),
    statelessCustomActions: (json['StatelessCustomActions'] as List<dynamic>?)
        ?.map((e) => e as String)
        .toList(),
    statelessDefaultActions: (json['StatelessDefaultActions'] as List<dynamic>?)
        ?.map((e) => e as String)
        .toList(),
    statelessFragmentDefaultActions:
        (json['StatelessFragmentDefaultActions'] as List<dynamic>?)
            ?.map((e) => e as String)
            .toList(),
    statelessRuleGroups: (json['StatelessRuleGroups'] as List<dynamic>?)
...
PartialMatch _$PartialMatchFromJson(Map<String, dynamic> json) {
  return PartialMatch(
    ...
    targetViolationReasons: (json['TargetViolationReasons'] as List<dynamic>?)
        ?.map((e) => e as String)
        .toList(),
  );
}
...
Policy _$PolicyFromJson(Map<String, dynamic> json) {
  return Policy(
    ...
    excludeMap: (json['ExcludeMap'] as Map<String, dynamic>?)?.map(
      (k, e) => MapEntry(_$enumDecode(_$CustomerPolicyScopeIdTypeEnumMap, k),
    ...
    resourceTags: (json['ResourceTags'] as List<dynamic>?)
        ...
        .toList(),
    resourceTypeList: (json['ResourceTypeList'] as List<dynamic>?)
        ?.map((e) => e as String)
        .toList(),
  );
}
...
Map<String, dynamic> _$PolicyToJson(Policy instance) {
  final val = <String, dynamic>{
    'ExcludeResourceTags': instance.excludeResourceTags,
    'PolicyName': instance.policyName,
    'RemediationEnabled': instance.remediationEnabled,
    'ResourceType': instance.resourceType,
    'SecurityServicePolicyData': instance.securityServicePolicyData.toJson(),
  };
...
PolicyComplianceDetail _$PolicyComplianceDetailFromJson(
  ...
  return PolicyComplianceDetail(
    ...
    issueInfoMap: (json['IssueInfoMap'] as Map<String, dynamic>?)?.map(
      (k, e) =>
          MapEntry(_$enumDecode(_$DependentServiceNameEnumMap, k), e as String),
    ),
    memberAccount: json['MemberAccount'] as String?,
    policyId: json['PolicyId'] as String?,
    policyOwner: json['PolicyOwner'] as String?,
    violators: (json['Violators'] as List<dynamic>?)
...
ProtocolsListData _$ProtocolsListDataFromJson(Map<String, dynamic> json) {
  return ProtocolsListData(
    listName: json['ListName'] as String,
    protocolsList: (json['ProtocolsList'] as List<dynamic>)
        .map((e) => e as String)
        .toList(),
    createTime: const UnixDateTimeConverter().fromJson(json['CreateTime']),
    lastUpdateTime:
...
Map<String, dynamic> _$ProtocolsListDataToJson(ProtocolsListData instance) {
  final val = <String, dynamic>{
    'ListName': instance.listName,
    'ProtocolsList': instance.protocolsList,
  };
...
SecurityServicePolicyData _$SecurityServicePolicyDataFromJson(
  ...
  return SecurityServicePolicyData(
    type: _$enumDecode(_$SecurityServiceTypeEnumMap, json['Type']),
...
Map<String, dynamic> _$SecurityServicePolicyDataToJson(
  ...
  final val = <String, dynamic>{
    'Type': _$SecurityServiceTypeEnumMap[instance.type],
  };
...
ViolationDetail _$ViolationDetailFromJson(Map<String, dynamic> json) {
  return ViolationDetail(
    ...
    resourceId: json['ResourceId'] as String,
    resourceType: json['ResourceType'] as String,
    resourceViolations: (json['ResourceViolations'] as List<dynamic>)
