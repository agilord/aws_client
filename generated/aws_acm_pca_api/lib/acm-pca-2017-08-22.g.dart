...
Map<String, dynamic> _$AccessDescriptionToJson(AccessDescription instance) =>
    <String, dynamic>{
      'AccessLocation': instance.accessLocation.toJson(),
      'AccessMethod': instance.accessMethod.toJson(),
    };
...
CertificateAuthorityConfiguration _$CertificateAuthorityConfigurationFromJson(
  ...
  return CertificateAuthorityConfiguration(
    keyAlgorithm: _$enumDecode(_$KeyAlgorithmEnumMap, json['KeyAlgorithm']),
    signingAlgorithm:
        _$enumDecode(_$SigningAlgorithmEnumMap, json['SigningAlgorithm']),
...
CsrExtensions _$CsrExtensionsFromJson(Map<String, dynamic> json) {
  return CsrExtensions(
    ...
    subjectInformationAccess:
        (json['SubjectInformationAccess'] as List<dynamic>?)
...
Permission _$PermissionFromJson(Map<String, dynamic> json) {
  return Permission(
    actions: (json['Actions'] as List<dynamic>?)
        ?.map((e) => _$enumDecode(_$ActionTypeEnumMap, e))
        .toList(),
    certificateAuthorityArn: json['CertificateAuthorityArn'] as String?,
    createdAt: const UnixDateTimeConverter().fromJson(json['CreatedAt']),
    policy: json['Policy'] as String?,
...
Map<String, dynamic> _$ValidityToJson(Validity instance) => <String, dynamic>{
      'Type': _$ValidityPeriodTypeEnumMap[instance.type],
      'Value': instance.value,
    };
