...
DeleteIdentitiesResponse _$DeleteIdentitiesResponseFromJson(
  ...
  return DeleteIdentitiesResponse(
    unprocessedIdentityIds: (json['UnprocessedIdentityIds'] as List<dynamic>?)
...
GetIdentityPoolRolesResponse _$GetIdentityPoolRolesResponseFromJson(
  ...
  return GetIdentityPoolRolesResponse(
    ...
    roleMappings: (json['RoleMappings'] as Map<String, dynamic>?)?.map(
      (k, e) => MapEntry(k, RoleMapping.fromJson(e as Map<String, dynamic>)),
    ),
...
IdentityPool _$IdentityPoolFromJson(Map<String, dynamic> json) {
  return IdentityPool(
    ...
    cognitoIdentityProviders: (json['CognitoIdentityProviders']
            as List<dynamic>?)
        ?.map(
            (e) => CognitoIdentityProvider.fromJson(e as Map<String, dynamic>))
        .toList(),
    ...
    openIdConnectProviderARNs:
        (json['OpenIdConnectProviderARNs'] as List<dynamic>?)
            ?.map((e) => e as String)
            .toList(),
    samlProviderARNs: (json['SamlProviderARNs'] as List<dynamic>?)
        ?.map((e) => e as String)
        .toList(),
...
ListIdentityPoolsResponse _$ListIdentityPoolsResponseFromJson(
  ...
  return ListIdentityPoolsResponse(
    identityPools: (json['IdentityPools'] as List<dynamic>?)
        ?.map((e) =>
...
LookupDeveloperIdentityResponse _$LookupDeveloperIdentityResponseFromJson(
  ...
  return LookupDeveloperIdentityResponse(
    developerUserIdentifierList:
        (json['DeveloperUserIdentifierList'] as List<dynamic>?)
            ?.map((e) => e as String)
            .toList(),
    identityId: json['IdentityId'] as String?,
    nextToken: json['NextToken'] as String?,
...
MappingRule _$MappingRuleFromJson(Map<String, dynamic> json) {
  return MappingRule(
    ...
    matchType: _$enumDecode(_$MappingRuleMatchTypeEnumMap, json['MatchType']),
...
Map<String, dynamic> _$MappingRuleToJson(MappingRule instance) =>
    <String, dynamic>{
      ...
      'MatchType': _$MappingRuleMatchTypeEnumMap[instance.matchType],
...
RoleMapping _$RoleMappingFromJson(Map<String, dynamic> json) {
  return RoleMapping(
    type: _$enumDecode(_$RoleMappingTypeEnumMap, json['Type']),
...
Map<String, dynamic> _$RoleMappingToJson(RoleMapping instance) {
  final val = <String, dynamic>{
    'Type': _$RoleMappingTypeEnumMap[instance.type],
  };
