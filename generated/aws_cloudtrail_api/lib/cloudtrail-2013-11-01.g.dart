...
AdvancedEventSelector _$AdvancedEventSelectorFromJson(
  ...
  return AdvancedEventSelector(
    fieldSelectors: (json['FieldSelectors'] as List<dynamic>)
...
Map<String, dynamic> _$AdvancedEventSelectorToJson(
  ...
  final val = <String, dynamic>{
    'FieldSelectors': instance.fieldSelectors.map((e) => e.toJson()).toList(),
  };
...
AdvancedFieldSelector _$AdvancedFieldSelectorFromJson(
  ...
  return AdvancedFieldSelector(
    ...
    endsWith:
        (json['EndsWith'] as List<dynamic>?)?.map((e) => e as String).toList(),
    equals:
        (json['Equals'] as List<dynamic>?)?.map((e) => e as String).toList(),
    notEndsWith: (json['NotEndsWith'] as List<dynamic>?)
        ?.map((e) => e as String)
        .toList(),
    notEquals:
        (json['NotEquals'] as List<dynamic>?)?.map((e) => e as String).toList(),
    notStartsWith: (json['NotStartsWith'] as List<dynamic>?)
        ?.map((e) => e as String)
        .toList(),
    startsWith: (json['StartsWith'] as List<dynamic>?)
        ?.map((e) => e as String)
        .toList(),
  );
}
...
EventSelector _$EventSelectorFromJson(Map<String, dynamic> json) {
  return EventSelector(
    dataResources: (json['DataResources'] as List<dynamic>?)
        ?.map((e) => DataResource.fromJson(e as Map<String, dynamic>))
        .toList(),
    excludeManagementEventSources:
        (json['ExcludeManagementEventSources'] as List<dynamic>?)
            ?.map((e) => e as String)
            .toList(),
...
Map<String, dynamic> _$EventSelectorToJson(EventSelector instance) {
  ...
  writeNotNull(
      'DataResources', instance.dataResources?.map((e) => e.toJson()).toList());
  writeNotNull(
...
GetEventSelectorsResponse _$GetEventSelectorsResponseFromJson(
  ...
  return GetEventSelectorsResponse(
    advancedEventSelectors: (json['AdvancedEventSelectors'] as List<dynamic>?)
        ?.map((e) => AdvancedEventSelector.fromJson(e as Map<String, dynamic>))
        .toList(),
    eventSelectors: (json['EventSelectors'] as List<dynamic>?)
...
GetInsightSelectorsResponse _$GetInsightSelectorsResponseFromJson(
  ...
  return GetInsightSelectorsResponse(
    insightSelectors: (json['InsightSelectors'] as List<dynamic>?)
...
ListPublicKeysResponse _$ListPublicKeysResponseFromJson(
  ...
  return ListPublicKeysResponse(
    ...
    publicKeyList: (json['PublicKeyList'] as List<dynamic>?)
...
ListTagsResponse _$ListTagsResponseFromJson(Map<String, dynamic> json) {
  return ListTagsResponse(
    nextToken: json['NextToken'] as String?,
    resourceTagList: (json['ResourceTagList'] as List<dynamic>?)
...
PublicKey _$PublicKeyFromJson(Map<String, dynamic> json) {
  return PublicKey(
    ...
    value:
        const Uint8ListNullableConverter().fromJson(json['Value'] as String?),
  );
}
