...
void main() {
  ...
  test('RestJsonHttpPayloadTraitsWithMediaTypeWithBlob', () async {
    final client = MockClient((request) async {
      ...
      expect(
          request.url, equalsPathAndQuery('/HttpPayloadTraitsWithMediaType'));
    ...
    await service.httpPayloadTraitsWithMediaType(
