...
void main() {
  ...
  test('RestJsonStreamingTraitsWithMediaTypeWithBlob', () async {
    final client = MockClient((request) async {
      ...
      expect(request.url, equalsPathAndQuery('/StreamingTraitsWithMediaType'));
    ...
    await service.streamingTraitsWithMediaType(
