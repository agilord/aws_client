...
void main() {
  ...
  test('AwsJson10SupportsNaNFloatInputs', () async {
    ...
    "doubleValue": "NaN"
      ...
      expect(
          request.headers['X-Amz-Target'], 'JsonRpc10.SimpleScalarProperties');
  ...
  test('AwsJson10SupportsInfinityFloatInputs', () async {
    final client = MockClient((request) async {
      expect(request.body, equalsJson(r'''{
    "floatValue": "Infinity",
  ...
  test('AwsJson10SupportsNegativeInfinityFloatInputs', () async {
    final client = MockClient((request) async {
      expect(request.body, equalsJson(r'''{
    "floatValue": "-Infinity",
    "doubleValue": "-Infinity"
