...
void main() {
  ...
  test('HttpPayloadWithXmlNamespace', () async {
    final client = MockClient((request) async {
      expect(request.body,
          equalsXml(r'''<PayloadWithXmlNamespace xmlns="http://foo.com">
    <name>Phreddy</name>
</PayloadWithXmlNamespace>'''));
      expect(request.headers['Content-Type'], startsWith('application/xml'));
      expect(request.url, equalsPathAndQuery('/HttpPayloadWithXmlNamespace'));
    ...
    await service.httpPayloadWithXmlNamespace(
  ...
  test('HttpPayloadWithXmlNamespace', () async {
    final client = MockClient((request) async {
      return Response(
          r'''<PayloadWithXmlNamespace xmlns="http://foo.com">
    <name>Phreddy</name>
</PayloadWithXmlNamespace>''',
          200,
