...
void main() {
  ...
  test('HttpPayloadWithXmlName', () async {
    final client = MockClient((request) async {
      expect(
          request.body, equalsXml(r'''<Hello><name>Phreddy</name></Hello>'''));
      expect(request.headers['Content-Type'], startsWith('application/xml'));
      expect(request.url, equalsPathAndQuery('/HttpPayloadWithXmlName'));
    ...
    await service.httpPayloadWithXmlName(
  ...
  test('HttpPayloadWithXmlName', () async {
    final client = MockClient((request) async {
      return Response(r'''<Hello><name>Phreddy</name></Hello>''', 200,
