...
void main() {
  ...
  test('XmlEmptyStrings', () async {
    final client = MockClient((request) async {
      expect(request.body, equalsXml(r'''<XmlEmptyStringsRequest>
    <emptyString></emptyString>
</XmlEmptyStringsRequest>
'''));
      expect(request.headers['Content-Type'], startsWith('application/xml'));
      expect(request.url, equalsPathAndQuery('/XmlEmptyStrings'));
...
''',
  ...
  test('XmlEmptySelfClosedStrings', () async {
    final client = MockClient((request) async {
      return Response(
          r'''<XmlEmptyStringsResponse>
    <emptyString/>
