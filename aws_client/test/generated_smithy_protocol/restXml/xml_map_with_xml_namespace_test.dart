...
void main() {
  ...
  test('RestXmlXmlMapWithXmlNamespace', () async {
    final client = MockClient((request) async {
      expect(request.body, equalsXml(r'''<XmlMapWithXmlNamespaceRequest>
    <KVP xmlns="https://the-member.example.com">
      ...
      expect(request.url, equalsPathAndQuery('/XmlMapWithXmlNamespace'));
    ...
    await service.xmlMapWithXmlNamespace(
      myMap: {
        "a": "A",
        "b": "B",
      },
  ...
  test('RestXmlXmlMapWithXmlNamespace', () async {
    final client = MockClient((request) async {
      return Response(
          r'''<XmlMapWithXmlNamespaceResponse>
    <KVP xmlns="https://the-member.example.com">
        <entry>
            <K xmlns="https://the-key.example.com">a</K>
            <V xmlns="https://the-value.example.com">A</V>
    ...
    final output = await service.xmlMapWithXmlNamespace();
