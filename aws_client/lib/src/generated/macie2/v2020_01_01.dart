...
class GetSensitiveDataOccurrencesAvailabilityResponse {
  ...
  /// object is encrypted with an KMS key that isn’t available. For example, the
  /// key is disabled, is scheduled for deletion, or was deleted.
  /// </li>
  /// <li>
...
class MatchingBucket {
  ...
  /// For example, the bucket has a restrictive bucket policy and Amazon S3 denied
  /// the request.
  /// </li>
  /// <li>
  /// BUCKET_COUNT_EXCEEDS_QUOTA - Retrieving and processing the information would
  /// exceed the quota for the number of buckets that Macie monitors for an
  /// account (10,000).
  /// </li>
  /// </ul>
...
class BucketMetadataErrorCode {
  ...
  static const bucketCountExceedsQuota =
      BucketMetadataErrorCode._('BUCKET_COUNT_EXCEEDS_QUOTA');

  final String value;

  const BucketMetadataErrorCode._(this.value);

  static const values = [accessDenied, bucketCountExceedsQuota];
