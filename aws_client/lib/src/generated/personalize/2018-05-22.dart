...
class Personalize {
  ...
  /// information on using filters, see <a>filter-batch</a>.
  ///
  /// Parameter [numResults] :
  ...
  /// schema when you call <a>CreateDataset</a>.
  /// <p class="title"> <b>Related APIs</b>
  ///
  /// <ul>
  /// <li>
  ...
  /// solution is created using the <a>CreateSolution</a> operation and must be
  /// in the ACTIVE state before calling <code>CreateSolutionVersion</code>. A
  /// new version of the solution is created every time you call this operation.
  ///
  /// <b>Status</b>
  ///
  ...
  /// the response. If you don't specify a domain, only non-domain recipes are
  /// returned.
  ///
  /// Parameter [maxResults] :
...
/// A truncated version of the <a>BatchSegmentJob</a> datatype. The
...
/// information on campaigns, see <a>CreateCampaign</a>.
class Campaign {
  /// The Amazon Resource Name (ARN) of the campaign.
...
/// listing, call the <a>DescribeRecommender</a> API.
...
class S3DataConfig {
  ...
  /// Amazon Personalize uses to encrypt or decrypt the input and output files of
...
/// <a>Solution</a> in a Custom dataset group.
