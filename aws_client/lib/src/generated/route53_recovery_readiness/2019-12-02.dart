...
class Route53RecoveryReadiness {
  ...
  Future<CreateCellResponse> createCell({
    ...
    ArgumentError.checkNotNull(cellName, 'cellName');
  ...
  Future<CreateReadinessCheckResponse> createReadinessCheck({
    ...
    ArgumentError.checkNotNull(readinessCheckName, 'readinessCheckName');
    ArgumentError.checkNotNull(resourceSetName, 'resourceSetName');
    final $payload = <String, dynamic>{
  ...
  Future<CreateRecoveryGroupResponse> createRecoveryGroup({
    ...
    ArgumentError.checkNotNull(recoveryGroupName, 'recoveryGroupName');
    final $payload = <String, dynamic>{
  ...
  Future<CreateResourceSetResponse> createResourceSet({
    ...
    ArgumentError.checkNotNull(resourceSetName, 'resourceSetName');
    ArgumentError.checkNotNull(resourceSetType, 'resourceSetType');
  ...
  Future<UpdateCellResponse> updateCell({
    ...
    ArgumentError.checkNotNull(cellName, 'cellName');
    ArgumentError.checkNotNull(cells, 'cells');
    final $payload = <String, dynamic>{
      'cells': cells,
    };
    final response = await _protocol.send(
