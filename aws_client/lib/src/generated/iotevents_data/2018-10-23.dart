...
class IoTEventsData {
  ...
  Future<BatchDisableAlarmResponse> batchDisableAlarm({
    ...
    ArgumentError.checkNotNull(disableActionRequests, 'disableActionRequests');
    final $payload = <String, dynamic>{
  ...
  Future<BatchEnableAlarmResponse> batchEnableAlarm({
    ...
    ArgumentError.checkNotNull(enableActionRequests, 'enableActionRequests');
    final $payload = <String, dynamic>{
  ...
  Future<BatchResetAlarmResponse> batchResetAlarm({
    ...
    ArgumentError.checkNotNull(resetActionRequests, 'resetActionRequests');
    final $payload = <String, dynamic>{
  ...
  Future<BatchSnoozeAlarmResponse> batchSnoozeAlarm({
    ...
    ArgumentError.checkNotNull(snoozeActionRequests, 'snoozeActionRequests');
    final $payload = <String, dynamic>{
...
extension on CustomerActionName {
  String toValue() {
    switch (this) {
