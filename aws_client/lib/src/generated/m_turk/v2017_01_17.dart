...
import 'v2017_01_17.endpoints.dart' as _endpoints;
...
class HIT {
  ...
  Map<String, dynamic> toJson() {
    ...
    return {
      ...
      if (hITId != null) 'HITId': hITId,
      if (hITLayoutId != null) 'HITLayoutId': hITLayoutId,
      if (hITReviewStatus != null) 'HITReviewStatus': hITReviewStatus.value,
      if (hITStatus != null) 'HITStatus': hITStatus.value,
      if (hITTypeId != null) 'HITTypeId': hITTypeId,
      if (keywords != null) 'Keywords': keywords,
      if (maxAssignments != null) 'MaxAssignments': maxAssignments,
