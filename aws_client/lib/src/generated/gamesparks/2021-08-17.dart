...
class GameSparks {
  ...
  Future<GetExtensionVersionResult> getExtensionVersion({
    ...
    ArgumentError.checkNotNull(extensionVersion, 'extensionVersion');
    ArgumentError.checkNotNull(name, 'name');
    ArgumentError.checkNotNull(namespace, 'namespace');
    final response = await _protocol.send(
      payload: null,
  ...
  Future<ImportGameConfigurationResult> importGameConfiguration({
    ...
    ArgumentError.checkNotNull(gameName, 'gameName');
    ArgumentError.checkNotNull(importSource, 'importSource');
    final $payload = <String, dynamic>{
  ...
  Future<StartGeneratedCodeJobResult> startGeneratedCodeJob({
    ...
    ArgumentError.checkNotNull(gameName, 'gameName');
    ArgumentError.checkNotNull(generator, 'generator');
    ArgumentError.checkNotNull(snapshotId, 'snapshotId');
    final $payload = <String, dynamic>{
      'Generator': generator,
    };
  ...
  Future<UpdateGameConfigurationResult> updateGameConfiguration({
    ...
    ArgumentError.checkNotNull(gameName, 'gameName');
    ArgumentError.checkNotNull(modifications, 'modifications');
    final $payload = <String, dynamic>{
...
extension on GeneratedCodeJobState {
  String toValue() {
    switch (this) {
...
class Generator {
  ...
  factory Generator.fromJson(Map<String, dynamic> json) {
    return Generator(
      gameSdkVersion: json['GameSdkVersion'] as String?,
...
class ImportGameConfigurationSource {
  ...
  factory ImportGameConfigurationSource.fromJson(Map<String, dynamic> json) {
...
class SectionModification {
  ...
  factory SectionModification.fromJson(Map<String, dynamic> json) {
