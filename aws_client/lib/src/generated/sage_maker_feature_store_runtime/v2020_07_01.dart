...
class SageMakerFeatureStoreRuntime {
  ...
  factory SageMakerFeatureStoreRuntime({
    ...
    return SageMakerFeatureStoreRuntime._(
  ...
  SageMakerFeatureStoreRuntime._({
  ...
  Future<BatchGetRecordResponse> batchGetRecord({
    ...
    final $payload = <String, dynamic>{
      ...
      if (expirationTimeResponse != null)
        'ExpirationTimeResponse': expirationTimeResponse.value,
    };
