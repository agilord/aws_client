...
class Account {
  ...
  Future<void> deleteAlternateContact({
    ...
    ArgumentError.checkNotNull(alternateContactType, 'alternateContactType');
  ...
  Future<void> putContactInformation({
    ...
    ArgumentError.checkNotNull(contactInformation, 'contactInformation');
    final $payload = <String, dynamic>{
...
extension on AlternateContactType {
  String toValue() {
    switch (this) {
