...
class NetworkManager {
  ...
  /// can be in any Amazon Web Services Region, but it must be owned by the same
...
class BgpOptions {
  ...
  factory BgpOptions.fromJson(Map<String, dynamic> json) {
    return BgpOptions(
...
extension on ConnectPeerAssociationState {
  String toValue() {
    switch (this) {
...
extension on CoreNetworkPolicyAlias {
  String toValue() {
    switch (this) {
...
extension on RouteAnalysisCompletionReasonCode {
  String toValue() {
    switch (this) {
...
extension on RouteAnalysisCompletionResultCode {
  String toValue() {
    switch (this) {
...
class RouteAnalysisEndpointOptionsSpecification {
  ...
  factory RouteAnalysisEndpointOptionsSpecification.fromJson(
      Map<String, dynamic> json) {
...
extension on RouteAnalysisStatus {
  String toValue() {
    switch (this) {
...
class RouteTableIdentifier {
  ...
  factory RouteTableIdentifier.fromJson(Map<String, dynamic> json) {
