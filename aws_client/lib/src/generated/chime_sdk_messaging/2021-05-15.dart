...
class ChimeSdkMessaging {
  ...
  Future<void> associateChannelFlow({
    ...
    ArgumentError.checkNotNull(channelFlowArn, 'channelFlowArn');
    ArgumentError.checkNotNull(chimeBearer, 'chimeBearer');
  ...
  /// The <code>AppInstanceUserArn</code>s of the members you want to add to the
  /// channel.
  ///
  /// Parameter [type] :
  ...
  Future<ChannelFlowCallbackResponse> channelFlowCallback({
    ...
    ArgumentError.checkNotNull(channelArn, 'channelArn');
    ArgumentError.checkNotNull(channelMessage, 'channelMessage');
    final $payload = <String, dynamic>{
  ...
  Future<CreateChannelFlowResponse> createChannelFlow({
    ...
    ArgumentError.checkNotNull(name, 'name');
    ArgumentError.checkNotNull(processors, 'processors');
    final $payload = <String, dynamic>{
      'AppInstanceArn': appInstanceArn,
  ...
  /// specified channel. The <code>AppInstanceUser</code> must be a member of
  /// the channel. Only the <code>AppInstanceUser</code> who owns the membership
  /// can retrieve preferences. Users in the <code>AppInstanceAdmin</code> and
  /// channel moderator roles can't retrieve preferences for other users. Banned
  /// users can't retrieve membership preferences for the channel from which
  /// they are banned.
  ///
  /// May throw [BadRequestException].
  /// May throw [UnauthorizedClientException].
  ...
  /// specified channel. The <code>AppInstanceUser</code> must be a member of
  /// the channel. Only the <code>AppInstanceUser</code> who owns the membership
  /// can set preferences. Users in the <code>AppInstanceAdmin</code> and
  ...
  Future<PutChannelMembershipPreferencesResponse>
    ...
    ArgumentError.checkNotNull(chimeBearer, 'chimeBearer');
    ArgumentError.checkNotNull(memberArn, 'memberArn');
    ArgumentError.checkNotNull(preferences, 'preferences');
    final headers = <String, String>{
      'x-amz-chime-bearer': chimeBearer.toString(),
    };
    final $payload = <String, dynamic>{
...
extension on AllowNotifications {
  String toValue() {
    switch (this) {
...
class ChannelMessageCallback {
  ...
  factory ChannelMessageCallback.fromJson(Map<String, dynamic> json) {
    return ChannelMessageCallback(
      ...
      pushNotification: json['PushNotification'] != null
          ? PushNotificationConfiguration.fromJson(
...
extension on ChannelMessageStatus {
  String toValue() {
    switch (this) {
...
class PushNotificationConfiguration {
  ...
  factory PushNotificationConfiguration.fromJson(Map<String, dynamic> json) {
    return PushNotificationConfiguration(
      body: json['Body'] as String?,
      title: json['Title'] as String?,
      type: (json['Type'] as String?)?.toPushNotificationType(),
    );
  }
...
extension on PushNotificationType {
  String toValue() {
    switch (this) {
...
class SearchField {
  ...
  factory SearchField.fromJson(Map<String, dynamic> json) {
    return SearchField(
      key: (json['Key'] as String).toSearchFieldKey(),
      operator: (json['Operator'] as String).toSearchFieldOperator(),
...
extension on SearchFieldOperator {
  String toValue() {
    switch (this) {
