...
class KafkaConnect {
  ...
  Future<CreateConnectorResponse> createConnector({
    ...
    ArgumentError.checkNotNull(connectorName, 'connectorName');
    ArgumentError.checkNotNull(kafkaCluster, 'kafkaCluster');
    ArgumentError.checkNotNull(
        kafkaClusterClientAuthentication, 'kafkaClusterClientAuthentication');
    ArgumentError.checkNotNull(
        kafkaClusterEncryptionInTransit, 'kafkaClusterEncryptionInTransit');
    ArgumentError.checkNotNull(kafkaConnectVersion, 'kafkaConnectVersion');
    ArgumentError.checkNotNull(plugins, 'plugins');
    ArgumentError.checkNotNull(
  ...
  Future<CreateWorkerConfigurationResponse> createWorkerConfiguration({
    ...
    ArgumentError.checkNotNull(name, 'name');
    ArgumentError.checkNotNull(propertiesFileContent, 'propertiesFileContent');
    final $payload = <String, dynamic>{
      'name': name,
  ...
  Future<DeleteConnectorResponse> deleteConnector({
    ...
    ArgumentError.checkNotNull(connectorArn, 'connectorArn');
  ...
  Future<DeleteCustomPluginResponse> deleteCustomPlugin({
    ...
    ArgumentError.checkNotNull(customPluginArn, 'customPluginArn');
    final response = await _protocol.send(
      payload: null,
      method: 'DELETE',
...
class AutoScaling {
  ...
  factory AutoScaling.fromJson(Map<String, dynamic> json) {
    return AutoScaling(
...
class AutoScalingUpdate {
  ...
  factory AutoScalingUpdate.fromJson(Map<String, dynamic> json) {
    return AutoScalingUpdate(
      maxWorkerCount: json['maxWorkerCount'] as int,
      mcuCount: json['mcuCount'] as int,
      minWorkerCount: json['minWorkerCount'] as int,
      scaleInPolicy: ScaleInPolicyUpdate.fromJson(
          json['scaleInPolicy'] as Map<String, dynamic>),
      scaleOutPolicy: ScaleOutPolicyUpdate.fromJson(
          json['scaleOutPolicy'] as Map<String, dynamic>),
    );
  }
  ...
  factory Capacity.fromJson(Map<String, dynamic> json) {
    return Capacity(
      autoScaling: json['autoScaling'] != null
          ? AutoScaling.fromJson(json['autoScaling'] as Map<String, dynamic>)
          : null,
      provisionedCapacity: json['provisionedCapacity'] != null
          ? ProvisionedCapacity.fromJson(
...
class CapacityUpdate {
  ...
  factory CapacityUpdate.fromJson(Map<String, dynamic> json) {
    return CapacityUpdate(
      autoScaling: json['autoScaling'] != null
          ? AutoScalingUpdate.fromJson(
              json['autoScaling'] as Map<String, dynamic>)
          : null,
      provisionedCapacity: json['provisionedCapacity'] != null
          ? ProvisionedCapacityUpdate.fromJson(
              json['provisionedCapacity'] as Map<String, dynamic>)
          : null,
    );
  }
...
class CloudWatchLogsLogDelivery {
  ...
  factory CloudWatchLogsLogDelivery.fromJson(Map<String, dynamic> json) {
...
extension on CustomPluginContentType {
  String toValue() {
    switch (this) {
...
class CustomPluginLocation {
  ...
  factory CustomPluginLocation.fromJson(Map<String, dynamic> json) {
...
extension on CustomPluginState {
  String toValue() {
    switch (this) {
...
class FirehoseLogDelivery {
  ...
  factory FirehoseLogDelivery.fromJson(Map<String, dynamic> json) {
...
class KafkaCluster {
  ...
  factory KafkaCluster.fromJson(Map<String, dynamic> json) {
    return KafkaCluster(
      apacheKafkaCluster: ApacheKafkaCluster.fromJson(
...
extension on KafkaClusterClientAuthenticationType {
  String toValue() {
    switch (this) {
...
extension on KafkaClusterEncryptionInTransitType {
  String toValue() {
    switch (this) {
...
class LogDelivery {
  ...
  factory LogDelivery.fromJson(Map<String, dynamic> json) {
    return LogDelivery(
      workerLogDelivery: WorkerLogDelivery.fromJson(
...
class Plugin {
  ...
  factory Plugin.fromJson(Map<String, dynamic> json) {
    return Plugin(
      customPlugin:
          CustomPlugin.fromJson(json['customPlugin'] as Map<String, dynamic>),
    );
  }
...
class ProvisionedCapacity {
  ...
  factory ProvisionedCapacity.fromJson(Map<String, dynamic> json) {
...
class ProvisionedCapacityUpdate {
  ...
  factory ProvisionedCapacityUpdate.fromJson(Map<String, dynamic> json) {
...
class S3LogDelivery {
  ...
  factory S3LogDelivery.fromJson(Map<String, dynamic> json) {
...
class ScaleInPolicy {
  ...
  factory ScaleInPolicy.fromJson(Map<String, dynamic> json) {
...
class ScaleInPolicyUpdate {
  ...
  factory ScaleInPolicyUpdate.fromJson(Map<String, dynamic> json) {
...
class ScaleOutPolicy {
  ...
  factory ScaleOutPolicy.fromJson(Map<String, dynamic> json) {
...
class ScaleOutPolicyUpdate {
  ...
  factory ScaleOutPolicyUpdate.fromJson(Map<String, dynamic> json) {
...
class WorkerConfiguration {
  ...
  factory WorkerConfiguration.fromJson(Map<String, dynamic> json) {
...
class WorkerLogDelivery {
  ...
  factory WorkerLogDelivery.fromJson(Map<String, dynamic> json) {
    return WorkerLogDelivery(
      cloudWatchLogs: json['cloudWatchLogs'] != null
          ? CloudWatchLogsLogDelivery.fromJson(
              json['cloudWatchLogs'] as Map<String, dynamic>)
          : null,
      firehose: json['firehose'] != null
          ? FirehoseLogDelivery.fromJson(
              json['firehose'] as Map<String, dynamic>)
          : null,
      s3: json['s3'] != null
          ? S3LogDelivery.fromJson(json['s3'] as Map<String, dynamic>)
          : null,
    );
  }
