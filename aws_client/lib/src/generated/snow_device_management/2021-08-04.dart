...
class SnowDeviceManagement {
  ...
  Future<DescribeDeviceOutput> describeDevice({
    ...
    ArgumentError.checkNotNull(managedDeviceId, 'managedDeviceId');
    final response = await _protocol.send(
      payload: null,
      method: 'POST',
      requestUri:
...
class Command {
  ...
  factory Command.fromJson(Map<String, dynamic> json) {
    return Command(
      reboot: json['reboot'] != null
          ? Reboot.fromJson(json['reboot'] as Map<String, dynamic>)
          : null,
...
extension on IpAddressAssignment {
  String toValue() {
    switch (this) {
...
extension on PhysicalConnectorType {
  String toValue() {
    switch (this) {
...
class Reboot {
  ...
  factory Reboot.fromJson(Map<String, dynamic> _) {
    return Reboot();
  }
...
class Unlock {
  ...
  factory Unlock.fromJson(Map<String, dynamic> _) {
    return Unlock();
  }
