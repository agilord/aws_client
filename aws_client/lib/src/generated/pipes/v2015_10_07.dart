...
class UpdatePipeSourceKinesisStreamParameters {
  ...
  /// sets the maximum age to infinite. When the value is set to infinite,
  /// EventBridge never discards old records.
  ...
  /// MaximumRetryAttempts is infinite, EventBridge retries failed records until
  /// the record expires in the event source.
  final int? maximumRetryAttempts;

  /// Define how to handle item process failures. <code>AUTOMATIC_BISECT</code>
