...
class Ivschat {
  ...
  /// connection (session) established with the token is valid for the specified
  /// duration.
  ///
  ...
  Future<CreateChatTokenResponse> createChatToken({
    ...
    ArgumentError.checkNotNull(roomIdentifier, 'roomIdentifier');
  ...
  Future<SendEventResponse> sendEvent({
    ...
    ArgumentError.checkNotNull(eventName, 'eventName');
    ArgumentError.checkNotNull(roomIdentifier, 'roomIdentifier');
    final $payload = <String, dynamic>{
      'eventName': eventName,
      'roomIdentifier': roomIdentifier,
...
extension on ChatTokenCapability {
  String toValue() {
    switch (this) {
