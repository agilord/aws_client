...
class LookoutEquipment {
  ...
  Future<CreateInferenceSchedulerResponse> createInferenceScheduler({
    ...
    ArgumentError.checkNotNull(dataUploadFrequency, 'dataUploadFrequency');
    ArgumentError.checkNotNull(
  ...
  Future<ListInferenceEventsResponse> listInferenceEvents({
    ...
    ArgumentError.checkNotNull(
        inferenceSchedulerName, 'inferenceSchedulerName');
    ArgumentError.checkNotNull(intervalEndTime, 'intervalEndTime');
    ArgumentError.checkNotNull(intervalStartTime, 'intervalStartTime');
    _s.validateNumRange(
      'maxResults',
      maxResults,
      1,
...
extension on DataUploadFrequency {
  String toValue() {
    switch (this) {
...
class DatasetSchema {
  ...
  factory DatasetSchema.fromJson(Map<String, dynamic> json) {
    return DatasetSchema(
      inlineDataSchema: json['InlineDataSchema'] == null
          ? null
          : jsonDecode(json['InlineDataSchema'] as String),
    );
  }
...
extension on InferenceExecutionStatus {
  String toValue() {
    switch (this) {
...
extension on InferenceSchedulerStatus {
  String toValue() {
    switch (this) {
...
extension on IngestionJobStatus {
  String toValue() {
    switch (this) {
...
class LabelsInputConfiguration {
  ...
  factory LabelsInputConfiguration.fromJson(Map<String, dynamic> json) {
    return LabelsInputConfiguration(
      s3InputConfiguration: LabelsS3InputConfiguration.fromJson(
          json['S3InputConfiguration'] as Map<String, dynamic>),
    );
  }
...
extension on StatisticalIssueStatus {
  String toValue() {
    switch (this) {
...
extension on TargetSamplingRate {
  String toValue() {
    switch (this) {
