...
class Panorama {
  ...
  Future<CreateApplicationInstanceResponse> createApplicationInstance({
    ...
    ArgumentError.checkNotNull(manifestPayload, 'manifestPayload');
  ...
  Future<CreateJobForDevicesResponse> createJobForDevices({
    ...
    required DeviceJobConfig deviceJobConfig,
    required JobType jobType,
  }) async {
    ArgumentError.checkNotNull(deviceIds, 'deviceIds');
    ArgumentError.checkNotNull(deviceJobConfig, 'deviceJobConfig');
  ...
  Future<CreateNodeFromTemplateJobResponse> createNodeFromTemplateJob({
    ...
    ArgumentError.checkNotNull(outputPackageName, 'outputPackageName');
    ArgumentError.checkNotNull(outputPackageVersion, 'outputPackageVersion');
    ArgumentError.checkNotNull(templateParameters, 'templateParameters');
  ...
  Future<void> deregisterPackageVersion({
    ...
    ArgumentError.checkNotNull(patchVersion, 'patchVersion');
    final $query = <String, List<String>>{
  ...
  Future<DescribeApplicationInstanceResponse> describeApplicationInstance({
    ...
    ArgumentError.checkNotNull(applicationInstanceId, 'applicationInstanceId');
    final response = await _protocol.send(
      payload: null,
      method: 'GET',
      requestUri:
...
extension on ApplicationInstanceHealthStatus {
  String toValue() {
    switch (this) {
...
extension on ApplicationInstanceStatus {
  String toValue() {
    switch (this) {
...
class DeviceJobConfig {
  ...
  factory DeviceJobConfig.fromJson(Map<String, dynamic> json) {
    return DeviceJobConfig(
      oTAJobConfig: json['OTAJobConfig'] != null
          ? OTAJobConfig.fromJson(json['OTAJobConfig'] as Map<String, dynamic>)
          : null,
    );
  }
...
extension on NetworkConnectionStatus {
  String toValue() {
    switch (this) {
...
extension on NodeFromTemplateJobStatus {
  String toValue() {
    switch (this) {
...
extension on NodeInstanceStatus {
  String toValue() {
    switch (this) {
...
extension on PackageImportJobStatus {
  String toValue() {
    switch (this) {
...
extension on PackageImportJobType {
  String toValue() {
    switch (this) {
