...
class AppRunner {
  ...
  Future<AssociateCustomDomainResponse> associateCustomDomain({
    ...
    ArgumentError.checkNotNull(serviceArn, 'serviceArn');
  ...
  Future<CreateServiceResponse> createService({
    ...
    ArgumentError.checkNotNull(sourceConfiguration, 'sourceConfiguration');
    final headers = <String, String>{
      'Content-Type': 'application/x-amz-json-1.0',
  ...
  Future<CreateVpcConnectorResponse> createVpcConnector({
    ...
    ArgumentError.checkNotNull(vpcConnectorName, 'vpcConnectorName');
    final headers = <String, String>{
      'Content-Type': 'application/x-amz-json-1.0',
  ...
  Future<DeleteVpcConnectorResponse> deleteVpcConnector({
    ...
    ArgumentError.checkNotNull(vpcConnectorArn, 'vpcConnectorArn');
    final headers = <String, String>{
      'Content-Type': 'application/x-amz-json-1.0',
...
extension on AutoScalingConfigurationStatus {
  String toValue() {
    switch (this) {
...
extension on CertificateValidationRecordStatus {
  String toValue() {
    switch (this) {
...
class CodeConfigurationValues {
  ...
  /// <code>AWSAPPRUNNER</code> are reserved for system use and aren't valid.
...
extension on ConfigurationSource {
  String toValue() {
    switch (this) {
...
extension on CustomDomainAssociationStatus {
  String toValue() {
    switch (this) {
...
class ImageConfiguration {
  ...
  /// An array of key-value pairs. Keys with a prefix of <code>AWSAPPRUNNER</code>
...
extension on ImageRepositoryType {
  String toValue() {
    switch (this) {
...
extension on ObservabilityConfigurationStatus {
  String toValue() {
    switch (this) {
...
extension on SourceCodeVersionType {
  String toValue() {
    switch (this) {
...
extension on VpcConnectorStatus {
  String toValue() {
    switch (this) {
