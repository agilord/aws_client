...
class XRay {
  ...
  /// <code>RetrievalToken</code>. A successful cancellation will return an HTTP
  /// 200 response.
  ///
  /// May throw [InvalidRequestException].
  ...
  /// X-Ray. For more information, see <a
  ...
  /// first execute <code>StartTraceRetrieval</code> to obtain the required
  ...
  ///
  /// The response is empty until the <code>RetrievalStatus</code> is
  /// <i>COMPLETE</i>. Retry the request after the status changes from
  /// <i>RUNNING</i> or <i>SCHEDULED</i> to <i>COMPLETE</i> to access the full
  /// service graph.
  ///
  ...
  /// Transaction-Search Log group, see <a
  /// href="https://docs.aws.amazon.com/xray/latest/api/API_GetTraceGraph.html">GetTraceGraph</a>.
  ///
  /// May throw [InvalidRequestException].
  /// May throw [ResourceNotFoundException].
  /// May throw [ThrottledException].
  ...
  /// <code>PutTraceSegments</code> and <i>OpenTelemetry protocol (OTLP)</i>
  /// endpoint. The Transaction Search feature requires a CloudWatchLogs
  ...
  /// Retrieves a list of traces for a given <code>RetrievalToken</code> from
  /// the CloudWatch log group generated by Transaction Search. For information
  /// on what each trace returns, see <a
  ...
  /// retrieval, use <code>StartTraceRetrieval</code>, which generates the
  /// required <code>RetrievalToken</code>.
  ///
  /// When the <code>RetrievalStatus</code> is not <i>COMPLETE</i>, the API will
  /// return an empty response. Retry the request once the retrieval has
  /// completed to access the full list of traces.
  ///
  ...
  /// accounts. For more details, see <a
  ...
  /// Search generated log group, see <a
  /// href="https://docs.aws.amazon.com/xray/latest/api/API_BatchGetTraces.html">BatchGetTraces</a>.
  ///
  /// May throw [InvalidRequestException].
  /// May throw [ResourceNotFoundException].
  ...
  /// Uploads segment documents to Amazon Web Services X-Ray. A segment document
  ...
  /// For example, 1-58406520-a006649127e371903a2de979. For trace IDs created by
  /// an X-Ray SDK, or by Amazon Web Services services integrated with X-Ray, a
  /// trace ID includes:
  ...
  /// <a href="https://www.w3.org/TR/trace-context/">W3C Trace Context
  /// specification</a>. A W3C trace ID must be formatted in the X-Ray trace ID
  /// format when sending to X-Ray. For example, a W3C trace ID
  /// <code>4efaaf4d1e8720b39541901950019ee5</code> should be formatted as
  /// <code>1-4efaaf4d-1e8720b39541901950019ee5</code> when sending to X-Ray.
  /// While X-Ray trace IDs include the original request timestamp in Unix epoch
  ...
  /// Search</a>.
  ///
  /// API returns a <code>RetrievalToken</code>, which can be used with
  /// <code>ListRetrievedTraces</code> or <code>GetRetrievedTracesGraph</code>
  /// to fetch results. Retrievals will time out after 60 minutes. To execute
  /// long time ranges, consider segmenting into multiple retrievals.
  ///
  /// If you are using <a
  /// href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Unified-Cross-Account.html">CloudWatch
  /// cross-account observability</a>, you can use this operation in a
  /// monitoring account to retrieve data from a linked source account, as long
  /// as both accounts have transaction search enabled.
  ///
  ...
  ///
  /// Parameter [endTime] :
  /// The end of the time range to retrieve traces. The range is inclusive, so
  ...
  /// indexed from CloudWatch Logs. For more information, see <a
  /// href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Transaction-Search.html">Transaction
  /// Search</a>.
  ///
  /// May throw [InvalidRequestException].
...
class CancelTraceRetrievalResult {
  ...
  factory CancelTraceRetrievalResult.fromJson(Map<String, dynamic> _) {
    return CancelTraceRetrievalResult();
  }
...
class GetIndexingRulesResult {
  ...
  factory GetIndexingRulesResult.fromJson(Map<String, dynamic> json) {
    return GetIndexingRulesResult(
      indexingRules: (json['IndexingRules'] as List?)
          ?.nonNulls
          .map((e) => IndexingRule.fromJson(e as Map<String, dynamic>))
          .toList(),
      nextToken: json['NextToken'] as String?,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    final indexingRules = this.indexingRules;
    final nextToken = this.nextToken;
    return {
      if (indexingRules != null) 'IndexingRules': indexingRules,
      if (nextToken != null) 'NextToken': nextToken,
    };
  }
}
...
class GetRetrievedTracesGraphResult {
  ...
  /// Retrieved services.
  final List<RetrievedService>? services;
  ...
  factory GetRetrievedTracesGraphResult.fromJson(Map<String, dynamic> json) {
    return GetRetrievedTracesGraphResult(
      nextToken: json['NextToken'] as String?,
      retrievalStatus:
          (json['RetrievalStatus'] as String?)?.let(RetrievalStatus.fromString),
      services: (json['Services'] as List?)
          ?.nonNulls
          .map((e) => RetrievedService.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
  ...
  Map<String, dynamic> toJson() {
    final nextToken = this.nextToken;
    final retrievalStatus = this.retrievalStatus;
    final services = this.services;
    return {
      if (nextToken != null) 'NextToken': nextToken,
      if (retrievalStatus != null) 'RetrievalStatus': retrievalStatus.value,
      if (services != null) 'Services': services,
    };
  }
}
...
class GetSamplingTargetsResult {
  ...
  final List<UnprocessedStatistics>? unprocessedBoostStatistics;
  ...
  factory GetSamplingTargetsResult.fromJson(Map<String, dynamic> json) {
    return GetSamplingTargetsResult(
      ...
      samplingTargetDocuments: (json['SamplingTargetDocuments'] as List?)
          ...
          .toList(),
      unprocessedBoostStatistics: (json['UnprocessedBoostStatistics'] as List?)
          ?.nonNulls
  ...
  Map<String, dynamic> toJson() {
    ...
    final unprocessedBoostStatistics = this.unprocessedBoostStatistics;
    ...
    return {
      ...
      if (unprocessedBoostStatistics != null)
        'UnprocessedBoostStatistics': unprocessedBoostStatistics,
...
class GetTraceSegmentDestinationResult {
  ...
  /// Status of the retrieval.
  final TraceSegmentDestinationStatus? status;
  ...
  factory GetTraceSegmentDestinationResult.fromJson(Map<String, dynamic> json) {
    return GetTraceSegmentDestinationResult(
      destination: (json['Destination'] as String?)
          ?.let(TraceSegmentDestination.fromString),
      status: (json['Status'] as String?)
          ?.let(TraceSegmentDestinationStatus.fromString),
    );
  }
...
class ListRetrievedTracesResult {
  ...
  /// Format of the requested traces.
  final TraceFormatType? traceFormat;

  /// Full traces for the specified requests.
  final List<RetrievedTrace>? traces;
  ...
  factory ListRetrievedTracesResult.fromJson(Map<String, dynamic> json) {
    return ListRetrievedTracesResult(
      nextToken: json['NextToken'] as String?,
      retrievalStatus:
          (json['RetrievalStatus'] as String?)?.let(RetrievalStatus.fromString),
      traceFormat:
          (json['TraceFormat'] as String?)?.let(TraceFormatType.fromString),
      traces: (json['Traces'] as List?)
          ?.nonNulls
          .map((e) => RetrievedTrace.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
  ...
  Map<String, dynamic> toJson() {
    final nextToken = this.nextToken;
    final retrievalStatus = this.retrievalStatus;
    final traceFormat = this.traceFormat;
    final traces = this.traces;
    return {
      if (nextToken != null) 'NextToken': nextToken,
      if (retrievalStatus != null) 'RetrievalStatus': retrievalStatus.value,
...
class StartTraceRetrievalResult {
  ...
  factory StartTraceRetrievalResult.fromJson(Map<String, dynamic> json) {
    return StartTraceRetrievalResult(
      retrievalToken: json['RetrievalToken'] as String?,
    );
  }

  Map<String, dynamic> toJson() {
    final retrievalToken = this.retrievalToken;
    return {
      if (retrievalToken != null) 'RetrievalToken': retrievalToken,
    };
  }
}
...
class UpdateIndexingRuleResult {
  ...
  factory UpdateIndexingRuleResult.fromJson(Map<String, dynamic> json) {
    return UpdateIndexingRuleResult(
      indexingRule: json['IndexingRule'] != null
          ? IndexingRule.fromJson(json['IndexingRule'] as Map<String, dynamic>)
          : null,
    );
  }

  Map<String, dynamic> toJson() {
    final indexingRule = this.indexingRule;
    return {
      if (indexingRule != null) 'IndexingRule': indexingRule,
    };
  }
}
...
class UpdateTraceSegmentDestinationResult {
  ...
  factory UpdateTraceSegmentDestinationResult.fromJson(
      Map<String, dynamic> json) {
    return UpdateTraceSegmentDestinationResult(
      destination: (json['Destination'] as String?)
          ?.let(TraceSegmentDestination.fromString),
      status: (json['Status'] as String?)
          ?.let(TraceSegmentDestinationStatus.fromString),
...
class TraceSegmentDestination {
  ...
  const TraceSegmentDestination._(this.value);

  static const values = [xRay, cloudWatchLogs];

  static TraceSegmentDestination fromString(String value) =>
      values.firstWhere((e) => e.value == value,
          orElse: () => TraceSegmentDestination._(value));

  @override
  bool operator ==(other) =>
      other is TraceSegmentDestination && other.value == value;
...
class TraceSegmentDestinationStatus {
  ...
  const TraceSegmentDestinationStatus._(this.value);

  static const values = [pending, active];

  static TraceSegmentDestinationStatus fromString(String value) =>
      values.firstWhere((e) => e.value == value,
          orElse: () => TraceSegmentDestinationStatus._(value));

  @override
  bool operator ==(other) =>
      other is TraceSegmentDestinationStatus && other.value == value;
...
class SamplingRule {
  ...
  /// Specifies the multiplier applied to the base sampling rate. This boost
  /// allows you to temporarily increase sampling without changing the rule's
  /// configuration.
  final SamplingRateBoost? samplingRateBoost;
  ...
  factory SamplingRule.fromJson(Map<String, dynamic> json) {
    return SamplingRule(
      ...
      samplingRateBoost: json['SamplingRateBoost'] != null
          ? SamplingRateBoost.fromJson(
              json['SamplingRateBoost'] as Map<String, dynamic>)
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    return {
      ...
      if (ruleARN != null) 'RuleARN': ruleARN,
      if (ruleName != null) 'RuleName': ruleName,
      if (samplingRateBoost != null) 'SamplingRateBoost': samplingRateBoost,
    };
  }
}
...
class SamplingRateBoost {
  ...
  /// next window.
  final int cooldownWindowMinutes;
  ...
  SamplingRateBoost({
    required this.cooldownWindowMinutes,
  ...
  Map<String, dynamic> toJson() {
    final cooldownWindowMinutes = this.cooldownWindowMinutes;
...
class IndexingRule {
  ...
  factory IndexingRule.fromJson(Map<String, dynamic> json) {
    return IndexingRule(
      modifiedAt: timeStampFromJson(json['ModifiedAt']),
      name: json['Name'] as String?,
      rule: json['Rule'] != null
          ? IndexingRuleValue.fromJson(json['Rule'] as Map<String, dynamic>)
          : null,
    );
  }
...
class IndexingRuleValue {
  ...
  /// traceIds.
  final ProbabilisticRuleValue? probabilistic;

  IndexingRuleValue({
    this.probabilistic,
  });

  factory IndexingRuleValue.fromJson(Map<String, dynamic> json) {
    return IndexingRuleValue(
      probabilistic: json['Probabilistic'] != null
          ? ProbabilisticRuleValue.fromJson(
              json['Probabilistic'] as Map<String, dynamic>)
          : null,
    );
  }

  Map<String, dynamic> toJson() {
    final probabilistic = this.probabilistic;
    return {
...
class ProbabilisticRuleValue {
  ...
  final double desiredSamplingPercentage;

  /// Applied sampling percentage of traceIds.
  final double? actualSamplingPercentage;
...
class IndexingRuleValueUpdate {
  /// Indexing rule configuration that is used to probabilistically sample
  /// traceIds.
  final ProbabilisticRuleValueUpdate? probabilistic;
...
class RetrievalStatus {
  ...
  static const complete = RetrievalStatus._('COMPLETE');
  static const failed = RetrievalStatus._('FAILED');
  static const cancelled = RetrievalStatus._('CANCELLED');
  static const timeout = RetrievalStatus._('TIMEOUT');

  final String value;

  const RetrievalStatus._(this.value);
  ...
  static RetrievalStatus fromString(String value) =>
      values.firstWhere((e) => e.value == value,
          orElse: () => RetrievalStatus._(value));

  @override
  bool operator ==(other) => other is RetrievalStatus && other.value == value;
...
class TraceFormatType {
  ...
  const TraceFormatType._(this.value);

  static const values = [xray, otel];

  static TraceFormatType fromString(String value) =>
      values.firstWhere((e) => e.value == value,
          orElse: () => TraceFormatType._(value));

  @override
  bool operator ==(other) => other is TraceFormatType && other.value == value;
...
class SamplingTargetDocument {
  ...
  final SamplingBoost? samplingBoost;
  ...
  factory SamplingTargetDocument.fromJson(Map<String, dynamic> json) {
    return SamplingTargetDocument(
      ...
      ruleName: json['RuleName'] as String?,
      samplingBoost: json['SamplingBoost'] != null
          ? SamplingBoost.fromJson(
              json['SamplingBoost'] as Map<String, dynamic>)
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    return {
      ...
      if (ruleName != null) 'RuleName': ruleName,
      if (samplingBoost != null) 'SamplingBoost': samplingBoost,
    };
  }
}
...
class SamplingBoost {
  ...
  final DateTime boostRateTTL;

  SamplingBoost({
    required this.boostRate,
    required this.boostRateTTL,
  });
...
class SamplingBoostStatisticsDocument {
  ...
  SamplingBoostStatisticsDocument({
    ...
    required this.sampledAnomalyCount,
    required this.serviceName,
    required this.timestamp,
  ...
  Map<String, dynamic> toJson() {
    ...
    final ruleName = this.ruleName;
    final sampledAnomalyCount = this.sampledAnomalyCount;
    final serviceName = this.serviceName;
    final timestamp = this.timestamp;
    final totalCount = this.totalCount;
    return {
...
class RetrievedService {
  ...
  factory RetrievedService.fromJson(Map<String, dynamic> json) {
...
class GraphLink {
  ...
  factory GraphLink.fromJson(Map<String, dynamic> json) {
    return GraphLink(
      destinationTraceIds: (json['DestinationTraceIds'] as List?)
          ?.nonNulls
          .map((e) => e as String)
          .toList(),
      referenceType: json['ReferenceType'] as String?,
      sourceTraceId: json['SourceTraceId'] as String?,
    );
  }

  Map<String, dynamic> toJson() {
    final destinationTraceIds = this.destinationTraceIds;
    final referenceType = this.referenceType;
    final sourceTraceId = this.sourceTraceId;
    return {
      if (destinationTraceIds != null)
        'DestinationTraceIds': destinationTraceIds,
      if (referenceType != null) 'ReferenceType': referenceType,
      if (sourceTraceId != null) 'SourceTraceId': sourceTraceId,
    };
  }
}
