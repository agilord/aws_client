...
/// other details about each of the actions and data types for Migration Hub
/// Strategy Recommendations (Strategy Recommendations). The topic for each
...
/// see &lt;a href=&quot;http://aws.amazon.com/tools/#SDKs&quot;&gt;AWS
/// SDKs&lt;/a&gt;.&lt;/p&gt; </code></pre>
class MigrationHubStrategyRecommendations {
  ...
  Future<StartImportFileTaskResponse> startImportFileTask({
    ...
    ArgumentError.checkNotNull(s3key, 's3key');
    final $payload = <String, dynamic>{
      'S3Bucket': s3Bucket,
      'name': name,
      's3key': s3key,
...
extension on AntipatternReportStatus {
  String toValue() {
    switch (this) {
...
extension on ApplicationComponentCriteria {
  String toValue() {
    switch (this) {
...
extension on AwsManagedTargetDestination {
  String toValue() {
    switch (this) {
...
extension on DatabaseManagementPreference {
  String toValue() {
    switch (this) {
...
class Group {
  ...
  factory Group.fromJson(Map<String, dynamic> json) {
    return Group(
      name: (json['name'] as String?)?.toGroupName(),
...
extension on HeterogeneousTargetDatabaseEngine {
  String toValue() {
    switch (this) {
...
extension on HomogeneousTargetDatabaseEngine {
  String toValue() {
    switch (this) {
...
extension on ImportFileTaskStatus {
  String toValue() {
    switch (this) {
...
extension on NoPreferenceTargetDestination {
  String toValue() {
    switch (this) {
...
extension on RecommendationReportStatus {
  String toValue() {
    switch (this) {
...
extension on RunTimeAssessmentStatus {
  String toValue() {
    switch (this) {
...
extension on SelfManageTargetDestination {
  String toValue() {
    switch (this) {
...
class SourceCode {
  ...
  factory SourceCode.fromJson(Map<String, dynamic> json) {
    return SourceCode(
      location: json['location'] as String?,
      sourceVersion: json['sourceVersion'] as String?,
      versionControl: (json['versionControl'] as String?)?.toVersionControl(),
    );
  }
...
extension on SrcCodeOrDbAnalysisStatus {
  String toValue() {
    switch (this) {
...
class StrategyOption {
  ...
  factory StrategyOption.fromJson(Map<String, dynamic> json) {
    return StrategyOption(
      ...
      targetDestination:
          (json['targetDestination'] as String?)?.toTargetDestination(),
      toolName: (json['toolName'] as String?)?.toTransformationToolName(),
    );
  }
...
extension on StrategyRecommendation {
  String toValue() {
    switch (this) {
...
extension on TargetDatabaseEngine {
  String toValue() {
    switch (this) {
...
extension on TargetDestination {
  String toValue() {
    switch (this) {
...
extension on TransformationToolName {
  String toValue() {
    switch (this) {
