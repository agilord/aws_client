...
class LookoutMetrics {
  ...
  Future<void> activateAnomalyDetector({
    ...
    ArgumentError.checkNotNull(anomalyDetectorArn, 'anomalyDetectorArn');
  ...
  Future<CreateAlertResponse> createAlert({
    ...
    ArgumentError.checkNotNull(alertName, 'alertName');
    ArgumentError.checkNotNull(anomalyDetectorArn, 'anomalyDetectorArn');
    _s.validateNumRange(
  ...
  Future<CreateAnomalyDetectorResponse> createAnomalyDetector({
    ...
    ArgumentError.checkNotNull(anomalyDetectorConfig, 'anomalyDetectorConfig');
    ArgumentError.checkNotNull(anomalyDetectorName, 'anomalyDetectorName');
    final $payload = <String, dynamic>{
  ...
  Future<CreateMetricSetResponse> createMetricSet({
    ...
    ArgumentError.checkNotNull(anomalyDetectorArn, 'anomalyDetectorArn');
    ArgumentError.checkNotNull(metricList, 'metricList');
    ArgumentError.checkNotNull(metricSetName, 'metricSetName');
    ArgumentError.checkNotNull(metricSource, 'metricSource');
    _s.validateNumRange(
      'offset',
      offset,
      0,
  ...
  Future<void> deleteAlert({
    ...
    ArgumentError.checkNotNull(alertArn, 'alertArn');
    final $payload = <String, dynamic>{
      'AlertArn': alertArn,
    };
    final response = await _protocol.send(
  ...
  Future<DescribeMetricSetResponse> describeMetricSet({
    ...
    ArgumentError.checkNotNull(metricSetArn, 'metricSetArn');
    final $payload = <String, dynamic>{
  ...
  Future<GetAnomalyGroupResponse> getAnomalyGroup({
    ...
    ArgumentError.checkNotNull(anomalyDetectorArn, 'anomalyDetectorArn');
    ArgumentError.checkNotNull(anomalyGroupId, 'anomalyGroupId');
    final $payload = <String, dynamic>{
      'AnomalyDetectorArn': anomalyDetectorArn,
  ...
  Future<ListAnomalyGroupSummariesResponse> listAnomalyGroupSummaries({
    ...
    ArgumentError.checkNotNull(anomalyDetectorArn, 'anomalyDetectorArn');
    ArgumentError.checkNotNull(sensitivityThreshold, 'sensitivityThreshold');
    _s.validateNumRange(
...
extension on AggregationFunction {
  String toValue() {
    switch (this) {
...
extension on AnomalyDetectionTaskStatus {
  String toValue() {
    switch (this) {
...
class AnomalyDetectorConfig {
  ...
  factory AnomalyDetectorConfig.fromJson(Map<String, dynamic> json) {
...
extension on AnomalyDetectorFailureType {
  String toValue() {
    switch (this) {
...
extension on AnomalyDetectorStatus {
  String toValue() {
    switch (this) {
...
class AnomalyGroupTimeSeries {
  ...
  factory AnomalyGroupTimeSeries.fromJson(Map<String, dynamic> json) {
...
class AnomalyGroupTimeSeriesFeedback {
  ...
  factory AnomalyGroupTimeSeriesFeedback.fromJson(Map<String, dynamic> json) {
...
class AutoDetectionMetricSource {
  ...
  factory AutoDetectionMetricSource.fromJson(Map<String, dynamic> json) {
    return AutoDetectionMetricSource(
      s3SourceConfig: json['S3SourceConfig'] != null
          ? AutoDetectionS3SourceConfig.fromJson(
...
class AutoDetectionS3SourceConfig {
  ...
  factory AutoDetectionS3SourceConfig.fromJson(Map<String, dynamic> json) {
...
extension on CSVFileCompression {
  String toValue() {
    switch (this) {
...
extension on JsonFileCompression {
  String toValue() {
    switch (this) {
...
class SampleDataS3SourceConfig {
  ...
  factory SampleDataS3SourceConfig.fromJson(Map<String, dynamic> json) {
    return SampleDataS3SourceConfig(
      fileFormatDescriptor: FileFormatDescriptor.fromJson(
          json['FileFormatDescriptor'] as Map<String, dynamic>),
      roleArn: json['RoleArn'] as String,
      historicalDataPathList: (json['HistoricalDataPathList'] as List?)
          ?.whereNotNull()
