...
class AppConfigData {
  ...
  /// in the response) and MUST be provided to subsequent
  ...
  Future<GetLatestConfigurationResponse> getLatestConfiguration({
    ...
    ArgumentError.checkNotNull(configurationToken, 'configurationToken');
  ...
  /// <a>GetLatestConfiguration</a> more frequently then every 60 seconds.
...
class GetLatestConfigurationResponse {
  ...
  /// This MUST be provided to the next call to
  ...
  factory GetLatestConfigurationResponse.fromJson(Map<String, dynamic> json) {
    return GetLatestConfigurationResponse(
      configuration:
          _s.decodeNullableUint8List(json['Configuration'] as String?),
      contentType: json['Content-Type'] as String?,
      nextPollConfigurationToken:
          json['Next-Poll-Configuration-Token'] as String?,
      nextPollIntervalInSeconds: json['Next-Poll-Interval-In-Seconds'] as int?,
    );
  }
