...
/// href="https://docs.aws.amazon.com/lightsail/latest/userguide/lightsail-how-to-set-up-and-configure-aws-cli">Amazon
...
class Lightsail {
  ...
  ///
  /// The <code>create contact method</code> operation supports tag-based access
  ...
  /// user interface (GUI) session. The primary URL initiates a web-based Amazon
  /// DCV session to the virtual computer's application. The secondary URL
  /// initiates a web-based Amazon DCV session to the virtual computer's
  /// operating session.
  ///
  ...
  /// your Lightsail instances for load balancing</a>. You can create up to 10
  ...
  /// <code>bucketName</code> specified. The default value for this parameter is
  /// <code>False</code>.
  /// </note>
  ///
  /// Parameter [pageToken] :
  ...
  ///
  /// The <code>put alarm</code> operation supports tag-based access control via
  ...
  /// <code><imagelabel></code> portion of the following image name example:
  ///
  /// <ul>
  /// <li>
  ...
  /// stopped for seven consecutive days, Amazon Lightsail automatically starts
  /// it for you. This action helps ensure that your database instance doesn't
  /// fall behind on any required maintenance updates.
  /// </note>
  ...
  /// bucket. If a CORS configuration exists, it is replaced with the specified
  /// configuration. For AWS CLI operations, this parameter can also be passed
  /// as a file. For more information, see <a
  /// href="https://docs.aws.amazon.com/lightsail/latest/userguide/configure-cors.html">Configuring
  /// cross-origin resource sharing (CORS)</a>.
  /// <note>
...
class RegionName {
  ...
  static const apSoutheast_3 = RegionName._('ap-southeast-3');
  static const apSoutheast_5 = RegionName._('ap-southeast-5');
...
class InputOrigin {
  ...
  /// The possible values are <code>ipv4</code> for IPv4 only, <code>ipv6</code>
  /// for IPv6 only, and <code>dualstack</code> for IPv4 and IPv6.
  final OriginIpAddressTypeEnum? ipAddressType;
...
class OriginIpAddressTypeEnum {
  ...
  static const dualstack = OriginIpAddressTypeEnum._('dualstack');

  final String value;

  const OriginIpAddressTypeEnum._(this.value);

  static const values = [ipv4, ipv6, dualstack];

  static OriginIpAddressTypeEnum fromString(String value) =>
      values.firstWhere((e) => e.value == value,
          orElse: () => OriginIpAddressTypeEnum._(value));

  @override
  bool operator ==(other) =>
      other is OriginIpAddressTypeEnum && other.value == value;
...
class Bucket {
  ...
  /// updating CORS configuration. For more information, see <a
  /// href="https://docs.aws.amazon.com/lightsail/latest/userguide/configure-cors.html">Configuring
  /// cross-origin resource sharing (CORS)</a>.
  final BucketCorsConfig? cors;
  ...
  factory Bucket.fromJson(Map<String, dynamic> json) {
    return Bucket(
      ...
      cors: json['cors'] != null
          ? BucketCorsConfig.fromJson(json['cors'] as Map<String, dynamic>)
          : null,
      createdAt: timeStampFromJson(json['createdAt']),
      location: json['location'] != null
          ? ResourceLocation.fromJson(json['location'] as Map<String, dynamic>)
...
/// loaded in one domain to interact with resources in a different domain. For
/// more information, see <a
/// href="https://docs.aws.amazon.com/lightsail/latest/userguide/configure-cors.html">Configuring
/// cross-origin resource sharing (CORS)</a>.
class BucketCorsConfig {
  ...
  /// to 64 KB.
  final List<BucketCorsRule>? rules;

  BucketCorsConfig({
    this.rules,
  });

  factory BucketCorsConfig.fromJson(Map<String, dynamic> json) {
    return BucketCorsConfig(
      rules: (json['rules'] as List?)
          ?.nonNulls
          .map((e) => BucketCorsRule.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
...
class BucketCorsRule {
  ...
  /// <ul>
  /// <li>
  /// <code>GET</code> - Retrieves data from the server, such as downloading files
  /// or viewing content.
  /// </li>
  /// <li>
  /// <code>PUT</code> - Uploads or replaces data on the server, such as uploading
  /// new files.
  /// </li>
  /// <li>
  /// <code>POST</code> - Sends data to the server for processing, such as
  /// submitting forms or creating new resources.
  /// </li>
  /// <li>
  /// <code>DELETE</code> - Removes data from the server, such as deleting files
  /// or resources.
  /// </li>
  /// <li>
  ...
  /// allowed in a preflight <code>OPTIONS</code> request. In response to any
  /// preflight <code>OPTIONS</code> request, Amazon S3 returns any requested
  ...
  /// the specified resource. A CORS rule can have only one
  /// <code>maxAgeSeconds</code> element.
  ...
  factory BucketCorsRule.fromJson(Map<String, dynamic> json) {
    return BucketCorsRule(
      allowedMethods: ((json['allowedMethods'] as List?) ?? const [])
          .nonNulls
          .map((e) => e as String)
          .toList(),
...
/// domain, Lightsail automatically updates the domain's name servers in Route
/// 53 to the name servers of the Lightsail DNS zone. Then, Lightsail
  ...
  factory Origin.fromJson(Map<String, dynamic> json) {
    return Origin(
      ipAddressType: (json['ipAddressType'] as String?)
          ?.let(OriginIpAddressTypeEnum.fromString),
      name: json['name'] as String?,
...
final _exceptionFns = <String, _s.AwsExceptionFn>{
  ...
  'RegionSetupInProgressException': (type, message) =>
      RegionSetupInProgressException(type: type, message: message),
