...
class CloudWatchEvidently {
  ...
  Future<BatchEvaluateFeatureResponse> batchEvaluateFeature({
    ...
    ArgumentError.checkNotNull(requests, 'requests');
  ...
  /// <pre><code> &lt;p&gt;You can associate as many as 50 tags with an
  ...
  Future<CreateExperimentResponse> createExperiment({
    ...
    ArgumentError.checkNotNull(metricGoals, 'metricGoals');
    ArgumentError.checkNotNull(name, 'name');
    ArgumentError.checkNotNull(project, 'project');
    ArgumentError.checkNotNull(treatments, 'treatments');
    _s.validateNumRange(
      'samplingRate',
      samplingRate,
      0,
  ...
  /// Tags don't have any semantic meaning to Amazon Web Services and are
  /// interpreted strictly as strings of characters.
  /// <pre><code> &lt;p&gt;You can associate as many as 50 tags with a
  ...
  Future<CreateFeatureResponse> createFeature({
    ...
    ArgumentError.checkNotNull(name, 'name');
    ArgumentError.checkNotNull(project, 'project');
    ArgumentError.checkNotNull(variations, 'variations');
    final $payload = <String, dynamic>{
      'name': name,
  ...
  /// audience segments.
  /// <pre><code> &lt;p&gt;For more information about segment pattern syntax,
  /// see &lt;a
  ...
  Future<void> deleteExperiment({
    ...
    ArgumentError.checkNotNull(experiment, 'experiment');
    ArgumentError.checkNotNull(project, 'project');
    final response = await _protocol.send(
      payload: null,
      method: 'DELETE',
  ...
  Future<void> deleteFeature({
    ...
    ArgumentError.checkNotNull(feature, 'feature');
    ArgumentError.checkNotNull(project, 'project');
    final response = await _protocol.send(
      payload: null,
      method: 'DELETE',
  ...
  Future<void> deleteLaunch({
    ...
    ArgumentError.checkNotNull(launch, 'launch');
    ArgumentError.checkNotNull(project, 'project');
    final response = await _protocol.send(
      payload: null,
      method: 'DELETE',
  ...
  Future<void> deleteSegment({
    ...
    ArgumentError.checkNotNull(segment, 'segment');
    final response = await _protocol.send(
      payload: null,
      method: 'DELETE',
  ...
  /// <code>entityID</code> matches an override rule, the user is served the
  /// variation specified by that rule.
  /// <pre><code> &lt;p&gt;If there is a current launch with this feature that
  /// uses segment overrides, and if the user session's
  ...
  /// <pre><code> &lt;p&gt;If you include this parameter, the value must be a
  /// JSON object. A JSON array is not supported.&lt;/p&gt; </code></pre>
  ...
  Future<GetExperimentResultsResponse> getExperimentResults({
    ...
    ArgumentError.checkNotNull(experiment, 'experiment');
    ArgumentError.checkNotNull(metricNames, 'metricNames');
    ArgumentError.checkNotNull(project, 'project');
    ArgumentError.checkNotNull(treatmentNames, 'treatmentNames');
    _s.validateNumRange(
      'period',
      period,
      300,
  ...
  Future<StartExperimentResponse> startExperiment({
    ...
    ArgumentError.checkNotNull(analysisCompleteTime, 'analysisCompleteTime');
    ArgumentError.checkNotNull(experiment, 'experiment');
    ArgumentError.checkNotNull(project, 'project');
    final $payload = <String, dynamic>{
...
extension on ChangeDirectionEnum {
  String toValue() {
    switch (this) {
...
class CloudWatchLogsDestinationConfig {
  ...
  factory CloudWatchLogsDestinationConfig.fromJson(Map<String, dynamic> json) {
  ...
  factory EvaluationRequest.fromJson(Map<String, dynamic> json) {
    return EvaluationRequest(
      ...
      evaluationContext: json['evaluationContext'] == null
          ? null
          : jsonDecode(json['evaluationContext'] as String),
    );
  }
...
class Event {
  ...
  factory Event.fromJson(Map<String, dynamic> json) {
    return Event(
      data: jsonDecode(json['data'] as String) as Object,
...
extension on ExperimentBaseStat {
  String toValue() {
    switch (this) {
...
extension on ExperimentReportName {
  String toValue() {
    switch (this) {
...
extension on ExperimentResultRequestType {
  String toValue() {
    switch (this) {
...
extension on ExperimentResultResponseType {
  String toValue() {
    switch (this) {
...
extension on ExperimentStopDesiredState {
  String toValue() {
    switch (this) {
...
extension on FeatureEvaluationStrategy {
  String toValue() {
    switch (this) {
...
class LaunchGroupConfig {
  ...
  factory LaunchGroupConfig.fromJson(Map<String, dynamic> json) {
...
extension on LaunchStopDesiredState {
  String toValue() {
    switch (this) {
...
class MetricDefinitionConfig {
  ...
  factory MetricDefinitionConfig.fromJson(Map<String, dynamic> json) {
...
class MetricGoalConfig {
  ...
  factory MetricGoalConfig.fromJson(Map<String, dynamic> json) {
    return MetricGoalConfig(
      metricDefinition: MetricDefinitionConfig.fromJson(
          json['metricDefinition'] as Map<String, dynamic>),
      desiredChange:
          (json['desiredChange'] as String?)?.toChangeDirectionEnum(),
    );
...
class MetricMonitorConfig {
  ...
  factory MetricMonitorConfig.fromJson(Map<String, dynamic> json) {
    return MetricMonitorConfig(
      metricDefinition: MetricDefinitionConfig.fromJson(
          json['metricDefinition'] as Map<String, dynamic>),
    );
  }
...
class OnlineAbConfig {
  ...
  factory OnlineAbConfig.fromJson(Map<String, dynamic> json) {
...
class ProjectDataDeliveryConfig {
  ...
  factory ProjectDataDeliveryConfig.fromJson(Map<String, dynamic> json) {
    return ProjectDataDeliveryConfig(
      cloudWatchLogs: json['cloudWatchLogs'] != null
          ? CloudWatchLogsDestinationConfig.fromJson(
              json['cloudWatchLogs'] as Map<String, dynamic>)
          : null,
      s3Destination: json['s3Destination'] != null
          ? S3DestinationConfig.fromJson(
              json['s3Destination'] as Map<String, dynamic>)
          : null,
    );
  }
...
class ScheduledSplitConfig {
  ...
  /// names. The values represent the percentage of traffic to allocate to that
  /// variation during this step.
  /// <pre><code> &lt;p&gt;The values is expressed in thousandths of a percent, so
  /// assigning a weight of 50000 assigns 50% of traffic to that
  /// variation.&lt;/p&gt; &lt;p&gt;If the sum of the weights for all the
  /// variations in a segment override does not add up to 100,000, then the
  /// remaining traffic that matches this segment is not assigned by this segment
  /// override, and instead moves on to the next segment override or the default
  ...
  factory ScheduledSplitConfig.fromJson(Map<String, dynamic> json) {
...
class ScheduledSplitsLaunchConfig {
  ...
  factory ScheduledSplitsLaunchConfig.fromJson(Map<String, dynamic> json) {
    return ScheduledSplitsLaunchConfig(
      steps: (json['steps'] as List)
          .whereNotNull()
          .map((e) => ScheduledSplitConfig.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
...
extension on SegmentReferenceResourceType {
  String toValue() {
    switch (this) {
...
class VariationConfig {
  ...
  factory VariationConfig.fromJson(Map<String, dynamic> json) {
...
extension on VariationValueType {
  String toValue() {
    switch (this) {
