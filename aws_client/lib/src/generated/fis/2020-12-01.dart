...
class Fis {
  ...
  Future<CreateExperimentTemplateResponse> createExperimentTemplate({
    ...
    ArgumentError.checkNotNull(stopConditions, 'stopConditions');
  ...
  Future<StartExperimentResponse> startExperiment({
    ...
    ArgumentError.checkNotNull(experimentTemplateId, 'experimentTemplateId');
    final $payload = <String, dynamic>{
...
class CreateExperimentTemplateActionInput {
  ...
  factory CreateExperimentTemplateActionInput.fromJson(
...
class CreateExperimentTemplateLogConfigurationInput {
  ...
  factory CreateExperimentTemplateLogConfigurationInput.fromJson(
      Map<String, dynamic> json) {
    return CreateExperimentTemplateLogConfigurationInput(
      ...
      cloudWatchLogsConfiguration: json['cloudWatchLogsConfiguration'] != null
          ? ExperimentTemplateCloudWatchLogsLogConfigurationInput.fromJson(
              json['cloudWatchLogsConfiguration'] as Map<String, dynamic>)
          : null,
      s3Configuration: json['s3Configuration'] != null
          ? ExperimentTemplateS3LogConfigurationInput.fromJson(
...
class CreateExperimentTemplateStopConditionInput {
  ...
  factory CreateExperimentTemplateStopConditionInput.fromJson(
      Map<String, dynamic> json) {
...
class CreateExperimentTemplateTargetInput {
  ...
  factory CreateExperimentTemplateTargetInput.fromJson(
      Map<String, dynamic> json) {
    return CreateExperimentTemplateTargetInput(
      ...
      filters: (json['filters'] as List?)
          ?.whereNotNull()
          .map((e) => ExperimentTemplateTargetInputFilter.fromJson(
...
extension on ExperimentActionStatus {
  String toValue() {
    switch (this) {
...
class ExperimentTemplateCloudWatchLogsLogConfigurationInput {
  ...
  factory ExperimentTemplateCloudWatchLogsLogConfigurationInput.fromJson(
      Map<String, dynamic> json) {
...
class ExperimentTemplateS3LogConfigurationInput {
  ...
  factory ExperimentTemplateS3LogConfigurationInput.fromJson(
      Map<String, dynamic> json) {
...
class ExperimentTemplateTargetInputFilter {
  ...
  factory ExperimentTemplateTargetInputFilter.fromJson(
      Map<String, dynamic> json) {
...
class UpdateExperimentTemplateActionInputItem {
  ...
  factory UpdateExperimentTemplateActionInputItem.fromJson(
      Map<String, dynamic> json) {
...
class UpdateExperimentTemplateLogConfigurationInput {
  ...
  factory UpdateExperimentTemplateLogConfigurationInput.fromJson(
      Map<String, dynamic> json) {
...
class UpdateExperimentTemplateStopConditionInput {
  ...
  factory UpdateExperimentTemplateStopConditionInput.fromJson(
      Map<String, dynamic> json) {
...
class UpdateExperimentTemplateTargetInput {
  ...
  factory UpdateExperimentTemplateTargetInput.fromJson(
      Map<String, dynamic> json) {
