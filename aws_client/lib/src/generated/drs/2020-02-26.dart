...
class Drs {
  ...
  Future<CreateExtendedSourceServerResponse> createExtendedSourceServer({
    ...
    ArgumentError.checkNotNull(sourceServerArn, 'sourceServerArn');
  ...
  Future<ReplicationConfigurationTemplate>
    ...
    ArgumentError.checkNotNull(pitPolicy, 'pitPolicy');
    ArgumentError.checkNotNull(
  ...
  Future<void> deleteRecoveryInstance({
    ...
    ArgumentError.checkNotNull(recoveryInstanceID, 'recoveryInstanceID');
    final $payload = <String, dynamic>{
  ...
  Future<ListExtensibleSourceServersResponse> listExtensibleSourceServers({
    ...
    ArgumentError.checkNotNull(stagingAccountID, 'stagingAccountID');
    _s.validateNumRange(
      'maxResults',
      maxResults,
      1,
  ...
  Future<StartFailbackLaunchResponse> startFailbackLaunch({
    ...
    ArgumentError.checkNotNull(recoveryInstanceIDs, 'recoveryInstanceIDs');
    final $payload = <String, dynamic>{
  ...
  Future<StartRecoveryResponse> startRecovery({
    ...
    ArgumentError.checkNotNull(sourceServers, 'sourceServers');
    final $payload = <String, dynamic>{
...
class DescribeRecoveryInstancesRequestFilters {
  ...
  factory DescribeRecoveryInstancesRequestFilters.fromJson(
      Map<String, dynamic> json) {
    return DescribeRecoveryInstancesRequestFilters(
      recoveryInstanceIDs: (json['recoveryInstanceIDs'] as List?)
          ?.whereNotNull()
          .map((e) => e as String)
          .toList(),
...
class DescribeRecoverySnapshotsRequestFilters {
  ...
  factory DescribeRecoverySnapshotsRequestFilters.fromJson(
      Map<String, dynamic> json) {
  ...
  factory DescribeSourceServersRequestFilters.fromJson(
    ...
    return DescribeSourceServersRequestFilters(
      ...
      sourceServerIDs: (json['sourceServerIDs'] as List?)
          ...
          .map((e) => e as String)
          .toList(),
      stagingAccountIDs: (json['stagingAccountIDs'] as List?)
          ?.whereNotNull()
          .map((e) => e as String)
          .toList(),
    );
...
extension on FailbackReplicationError {
  String toValue() {
    switch (this) {
...
extension on PITPolicyRuleUnits {
  String toValue() {
    switch (this) {
...
extension on RecoveryInstanceDataReplicationInitiationStepName {
  String toValue() {
    switch (this) {
...
extension on RecoveryInstanceDataReplicationInitiationStepStatus {
  String toValue() {
    switch (this) {
...
extension on RecoveryInstanceDataReplicationState {
  String toValue() {
    switch (this) {
...
extension on RecoverySnapshotsOrder {
  String toValue() {
    switch (this) {
...
class StartRecoveryRequestSourceServer {
  ...
  factory StartRecoveryRequestSourceServer.fromJson(Map<String, dynamic> json) {
    return StartRecoveryRequestSourceServer(
      sourceServerID: json['sourceServerID'] as String,
      recoverySnapshotID: json['recoverySnapshotID'] as String?,
    );
  }
