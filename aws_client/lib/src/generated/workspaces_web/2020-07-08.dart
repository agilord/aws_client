...
class WorkSpacesWeb {
  ...
  Future<AssociateBrowserSettingsResponse> associateBrowserSettings({
    ...
    ArgumentError.checkNotNull(browserSettingsArn, 'browserSettingsArn');
    ArgumentError.checkNotNull(portalArn, 'portalArn');
  ...
  Future<AssociateNetworkSettingsResponse> associateNetworkSettings({
    ...
    ArgumentError.checkNotNull(networkSettingsArn, 'networkSettingsArn');
    ArgumentError.checkNotNull(portalArn, 'portalArn');
    final $query = <String, List<String>>{
  ...
  Future<AssociateTrustStoreResponse> associateTrustStore({
    ...
    ArgumentError.checkNotNull(portalArn, 'portalArn');
    ArgumentError.checkNotNull(trustStoreArn, 'trustStoreArn');
    final $query = <String, List<String>>{
  ...
  Future<AssociateUserSettingsResponse> associateUserSettings({
    ...
    ArgumentError.checkNotNull(portalArn, 'portalArn');
    ArgumentError.checkNotNull(userSettingsArn, 'userSettingsArn');
    final $query = <String, List<String>>{
  ...
  Future<CreateBrowserSettingsResponse> createBrowserSettings({
    ...
    ArgumentError.checkNotNull(browserPolicy, 'browserPolicy');
  ...
  Future<CreateTrustStoreResponse> createTrustStore({
    ...
    ArgumentError.checkNotNull(certificateList, 'certificateList');
    final $payload = <String, dynamic>{
  ...
  Future<CreateUserSettingsResponse> createUserSettings({
    ...
    ArgumentError.checkNotNull(copyAllowed, 'copyAllowed');
    ArgumentError.checkNotNull(downloadAllowed, 'downloadAllowed');
    ArgumentError.checkNotNull(pasteAllowed, 'pasteAllowed');
    ArgumentError.checkNotNull(printAllowed, 'printAllowed');
    ArgumentError.checkNotNull(uploadAllowed, 'uploadAllowed');
    _s.validateNumRange(
  ...
  Future<void> deleteIdentityProvider({
    ...
    ArgumentError.checkNotNull(identityProviderArn, 'identityProviderArn');
    final response = await _protocol.send(
      payload: null,
      method: 'DELETE',
      requestUri:
  ...
  Future<GetTrustStoreCertificateResponse> getTrustStoreCertificate({
    ...
    ArgumentError.checkNotNull(thumbprint, 'thumbprint');
    ArgumentError.checkNotNull(trustStoreArn, 'trustStoreArn');
    final $query = <String, List<String>>{
