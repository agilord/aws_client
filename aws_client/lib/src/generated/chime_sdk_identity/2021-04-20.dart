...
class ChimeSdkIdentity {
  ...
  Future<RegisterAppInstanceUserEndpointResponse>
    ...
    ArgumentError.checkNotNull(appInstanceUserArn, 'appInstanceUserArn');
    ArgumentError.checkNotNull(endpointAttributes, 'endpointAttributes');
    ArgumentError.checkNotNull(resourceArn, 'resourceArn');
...
extension on AppInstanceUserEndpointType {
  String toValue() {
    switch (this) {
...
extension on EndpointStatusReason {
  String toValue() {
    switch (this) {
