...
class FinSpaceData {
  ...
  Future<AssociateUserToPermissionGroupResponse>
    ...
    ArgumentError.checkNotNull(permissionGroupId, 'permissionGroupId');
  ...
  Future<CreateChangesetResponse> createChangeset({
    ...
    ArgumentError.checkNotNull(changeType, 'changeType');
    ArgumentError.checkNotNull(datasetId, 'datasetId');
    ArgumentError.checkNotNull(formatParams, 'formatParams');
    ArgumentError.checkNotNull(sourceParams, 'sourceParams');
    final $payload = <String, dynamic>{
  ...
  Future<CreateDataViewResponse> createDataView({
    ...
    ArgumentError.checkNotNull(datasetId, 'datasetId');
    ArgumentError.checkNotNull(destinationTypeParams, 'destinationTypeParams');
    final $payload = <String, dynamic>{
  ...
  Future<CreateDatasetResponse> createDataset({
    ...
    ArgumentError.checkNotNull(datasetTitle, 'datasetTitle');
    ArgumentError.checkNotNull(kind, 'kind');
    ArgumentError.checkNotNull(permissionGroupParams, 'permissionGroupParams');
    final $payload = <String, dynamic>{
  ...
  Future<GetDataViewResponse> getDataView({
    ...
    ArgumentError.checkNotNull(dataViewId, 'dataViewId');
    ArgumentError.checkNotNull(datasetId, 'datasetId');
    final response = await _protocol.send(
      payload: null,
      method: 'GET',
...
extension on ApplicationPermission {
  String toValue() {
    switch (this) {
...
extension on PermissionGroupMembershipStatus {
  String toValue() {
    switch (this) {
...
class PermissionGroupParams {
  ...
  factory PermissionGroupParams.fromJson(Map<String, dynamic> json) {
    return PermissionGroupParams(
      datasetPermissions: (json['datasetPermissions'] as List?)
          ?.whereNotNull()
