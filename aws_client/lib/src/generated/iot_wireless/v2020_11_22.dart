...
import 'v2020_11_22.endpoints.dart' as _endpoints;
export '../../shared/shared.dart' show AwsClientCredentials;

/// AWS IoT Wireless provides bi-directional communication between
/// internet-connected wireless devices and the AWS Cloud. To onboard both <a
/// href="https://docs.aws.amazon.com/iot-wireless/latest/developerguide/iot-lorawan.html">LoRaWAN</a>
/// and <a
/// href="https://docs.aws.amazon.com/iot-wireless/latest/developerguide/iot-sidewalk.html">Sidewalk</a>
/// devices to AWS IoT, use the IoT Wireless API. These wireless devices use the
/// Low Power Wide Area Networking (LPWAN) communication protocol to communicate
/// with AWS IoT.
///
...
/// connect to the endpoints and send requests to the AWS IoT Wireless service.
...
class IoTWireless {
  ...
  /// on the resource type, log levels can be returned for wireless device,
  /// wireless gateway, or FUOTA task log options.
  ///
  /// May throw [AccessDeniedException].
  /// May throw [InternalServerException].
  /// May throw [ResourceNotFoundException].
  ...
  /// href="https://docs.aws.amazon.com/iot-wireless/latest/apireference/API_GetResourcePosition.html">GetResourcePosition</a>
  ...
  ///
  /// Parameter [resourceType] :
  /// The type of resource, which can be <code>WirelessDevice</code>,
  /// <code>WirelessGateway</code>, or <code>FuotaTask</code>.
  ...
  /// configuration should use the <a
  /// href="https://docs.aws.amazon.com/iot-wireless/latest/apireference/API_UpdateResourcePosition.html">UpdateResourcePosition</a>
  /// API operation instead.
  /// </important>
  ///
  /// May throw [AccessDeniedException].
  ...
  /// wireless device, wireless gateway, or FUOTA task log options, and is used
...
class GetLogLevelsByResourceTypesResponse {
  ...
  factory GetLogLevelsByResourceTypesResponse.fromJson(
    ...
    return GetLogLevelsByResourceTypesResponse(
      ...
      fuotaTaskLogOptions: (json['FuotaTaskLogOptions'] as List?)
          ?.nonNulls
          .map((e) => FuotaTaskLogOption.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  Map<String, dynamic> toJson() {
    ...
    final fuotaTaskLogOptions = this.fuotaTaskLogOptions;
...
class ListDevicesForWirelessDeviceImportTaskResponse {
  ...
  final SidewalkListDevicesForImportInfo? sidewalk;
  ...
  factory ListDevicesForWirelessDeviceImportTaskResponse.fromJson(
    ...
    return ListDevicesForWirelessDeviceImportTaskResponse(
      ...
      positioning: (json['Positioning'] as String?)
          ?.let(PositioningConfigStatus.fromString),
      sidewalk: json['Sidewalk'] != null
          ? SidewalkListDevicesForImportInfo.fromJson(
              json['Sidewalk'] as Map<String, dynamic>)
          : null,
    );
  }
...
class SidewalkPositioning {
  ...
  factory SidewalkPositioning.fromJson(Map<String, dynamic> json) {
    return SidewalkPositioning(
      destinationName: json['DestinationName'] as String?,
    );
  }
...
class ParticipatingGatewaysMulticast {
  ...
  /// in the order that you provided. If the gateway list is empty, then AWS IoT
  /// Core for LoRaWAN chooses the gateways that were most recently used by the
  /// devices to send an uplink message.
  final List<String>? gatewayList;
  ...
  factory ParticipatingGatewaysMulticast.fromJson(Map<String, dynamic> json) {
    return ParticipatingGatewaysMulticast(
  ...
  Map<String, dynamic> toJson() {
    ...
    return {
      if (gatewayList != null) 'GatewayList': gatewayList,
...
class FuotaTaskLogOption {
  ...
  /// The FUOTA task type.
  final FuotaTaskType type;
  final List<FuotaTaskEventLogOption>? events;
  ...
  factory FuotaTaskLogOption.fromJson(Map<String, dynamic> json) {
    return FuotaTaskLogOption(
      logLevel: LogLevel.fromString((json['LogLevel'] as String?) ?? ''),
      type: FuotaTaskType.fromString((json['Type'] as String?) ?? ''),
      events: (json['Events'] as List?)
          ?.nonNulls
          .map((e) =>
              FuotaTaskEventLogOption.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
...
class FuotaTaskType {
  ...
  const FuotaTaskType._(this.value);

  static const values = [loRaWAN];

  static FuotaTaskType fromString(String value) =>
      values.firstWhere((e) => e.value == value,
          orElse: () => FuotaTaskType._(value));

  @override
  bool operator ==(other) => other is FuotaTaskType && other.value == value;
...
class FuotaTaskEventLogOption {
  ...
  factory FuotaTaskEventLogOption.fromJson(Map<String, dynamic> json) {
    return FuotaTaskEventLogOption(
      event: FuotaTaskEvent.fromString((json['Event'] as String?) ?? ''),
      logLevel: LogLevel.fromString((json['LogLevel'] as String?) ?? ''),
    );
  }
...
class FuotaTaskEvent {
  ...
  const FuotaTaskEvent._(this.value);

  static const values = [fuota];

  static FuotaTaskEvent fromString(String value) =>
      values.firstWhere((e) => e.value == value,
          orElse: () => FuotaTaskEvent._(value));

  @override
  bool operator ==(other) => other is FuotaTaskEvent && other.value == value;
...
class SidewalkListDevicesForImportInfo {
  ...
  factory SidewalkListDevicesForImportInfo.fromJson(Map<String, dynamic> json) {
    return SidewalkListDevicesForImportInfo(
      positioning: json['Positioning'] != null
          ? SidewalkPositioning.fromJson(
              json['Positioning'] as Map<String, dynamic>)
          : null,
...
class LoRaWANGetServiceProfileInfo {
  ...
  ///
  /// Default: <code>3</code>
  final int? nbTransMax;

  /// The minimum number of transmissions.
  ///
  /// Default: <code>0</code>
  final int? nbTransMin;
  ...
  final int? txPowerIndexMax;

  /// The Transmit Power Index minimum value.
  ///
  /// Default: <code>0</code>
  final int? txPowerIndexMin;
  ...
  LoRaWANGetServiceProfileInfo({
    ...
    this.targetPer,
    this.txPowerIndexMax,
    this.txPowerIndexMin,
    this.ulBucketSize,
    this.ulRate,
    this.ulRatePolicy,
  });
  ...
  factory LoRaWANGetServiceProfileInfo.fromJson(Map<String, dynamic> json) {
    return LoRaWANGetServiceProfileInfo(
      ...
      nbTransMax: json['NbTransMax'] as int?,
      nbTransMin: json['NbTransMin'] as int?,
      ...
      txPowerIndexMax: json['TxPowerIndexMax'] as int?,
      txPowerIndexMin: json['TxPowerIndexMin'] as int?,
  ...
  Map<String, dynamic> toJson() {
    ...
    final nbTransMax = this.nbTransMax;
    final nbTransMin = this.nbTransMin;
    ...
    final txPowerIndexMax = this.txPowerIndexMax;
    final txPowerIndexMin = this.txPowerIndexMin;
    ...
    return {
      ...
      if (nbTransMax != null) 'NbTransMax': nbTransMax,
      if (nbTransMin != null) 'NbTransMin': nbTransMin,
      ...
      if (txPowerIndexMax != null) 'TxPowerIndexMax': txPowerIndexMax,
      if (txPowerIndexMin != null) 'TxPowerIndexMin': txPowerIndexMin,
...
class AdvancedConfiguration {
  ...
  Map<String, dynamic> toJson() {
    final wiFiCellular = this.wiFiCellular;
    return {
      if (wiFiCellular != null) 'WiFiCellular': wiFiCellular,
    };
  }
}
...
class WiFiCellular {
  ...
  Map<String, dynamic> toJson() {
    final confidencePercent = this.confidencePercent;
    return {
...
class LoRaWANMulticastGet {
  ...
  factory LoRaWANMulticastGet.fromJson(Map<String, dynamic> json) {
    return LoRaWANMulticastGet(
      ...
      participatingGateways: json['ParticipatingGateways'] != null
          ? ParticipatingGatewaysMulticast.fromJson(
              json['ParticipatingGateways'] as Map<String, dynamic>)
          : null,
      rfRegion:
