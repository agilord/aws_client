...
class ApplicationCostProfiler {
  ...
  Future<PutReportDefinitionResult> putReportDefinition({
    ...
    ArgumentError.checkNotNull(destinationS3Location, 'destinationS3Location');
    ArgumentError.checkNotNull(format, 'format');
    ArgumentError.checkNotNull(reportDescription, 'reportDescription');
...
class SourceS3Location {
  ...
  factory SourceS3Location.fromJson(Map<String, dynamic> json) {
    return SourceS3Location(
      bucket: json['bucket'] as String,
      key: json['key'] as String,
      region: (json['region'] as String?)?.toS3BucketRegion(),
    );
  }
