...
/// answers quickly. Use the Amazon Connect Wisdom APIs to create an assistant
...
class ConnectWisdom {
  ...
  Future<CreateAssistantAssociationResponse> createAssistantAssociation({
    ...
    ArgumentError.checkNotNull(assistantId, 'assistantId');
    ArgumentError.checkNotNull(association, 'association');
  ...
  Future<CreateContentResponse> createContent({
    ...
    ArgumentError.checkNotNull(knowledgeBaseId, 'knowledgeBaseId');
    ArgumentError.checkNotNull(name, 'name');
  ...
  /// <pre><code> &lt;p&gt;For example, you're programmatically managing your
  /// external knowledge base, and you want to add or remove one of the fields
  ...
  Future<CreateKnowledgeBaseResponse> createKnowledgeBase({
    ...
    ArgumentError.checkNotNull(knowledgeBaseType, 'knowledgeBaseType');
    ArgumentError.checkNotNull(name, 'name');
    final $payload = <String, dynamic>{
  ...
  Future<void> deleteContent({
    ...
    ArgumentError.checkNotNull(contentId, 'contentId');
    ArgumentError.checkNotNull(knowledgeBaseId, 'knowledgeBaseId');
    final response = await _protocol.send(
      payload: null,
      method: 'DELETE',
  ...
  Future<NotifyRecommendationsReceivedResponse> notifyRecommendationsReceived({
    ...
    ArgumentError.checkNotNull(assistantId, 'assistantId');
    ArgumentError.checkNotNull(recommendationIds, 'recommendationIds');
    ArgumentError.checkNotNull(sessionId, 'sessionId');
    final $payload = <String, dynamic>{
  ...
  Future<SearchContentResponse> searchContent({
    ...
    ArgumentError.checkNotNull(knowledgeBaseId, 'knowledgeBaseId');
    ArgumentError.checkNotNull(searchExpression, 'searchExpression');
    _s.validateNumRange(
      'maxResults',
      maxResults,
      1,
  ...
  Future<UpdateKnowledgeBaseTemplateUriResponse>
    ...
    ArgumentError.checkNotNull(knowledgeBaseId, 'knowledgeBaseId');
    ArgumentError.checkNotNull(templateUri, 'templateUri');
    final $payload = <String, dynamic>{
...
class AssistantAssociationInputData {
  ...
  factory AssistantAssociationInputData.fromJson(Map<String, dynamic> json) {
...
class Filter {
  ...
  factory Filter.fromJson(Map<String, dynamic> json) {
    return Filter(
      field: (json['field'] as String).toFilterField(),
...
extension on KnowledgeBaseStatus {
  String toValue() {
    switch (this) {
...
extension on KnowledgeBaseType {
  String toValue() {
    switch (this) {
...
extension on RecommendationTriggerType {
  String toValue() {
    switch (this) {
...
class RenderingConfiguration {
  ...
  /// <code>active</code>
  /// </li>
  /// </ul> <pre><code> &lt;p&gt;The variable is replaced with the actual value
  /// for a piece of content when calling &lt;a
