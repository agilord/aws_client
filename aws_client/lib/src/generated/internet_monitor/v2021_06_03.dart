...
import 'v2021_06_03.endpoints.dart' as _endpoints;
...
class InternetMonitor {
  ...
  /// Services location. Must provide an Amazon Web Services location to search.
  /// </li>
  /// <li>
  /// <code>ROUTING_SUGGESTIONS</code>: Provides the predicted average
  /// round-trip time (RTT) from an IP prefix toward an Amazon Web Services
  /// location for a DNS resolver. The RTT is calculated at one hour intervals,
...
class QueryType {
  ...
  static const routingSuggestions = QueryType._('ROUTING_SUGGESTIONS');
