...
class ManagedGrafana {
  ...
  Future<AssociateLicenseResponse> associateLicense({
    ...
    ArgumentError.checkNotNull(licenseType, 'licenseType');
  ...
  /// Sign On, or both to authenticate users for using the Grafana console
  /// within a workspace. For more information, see <a
  ...
  /// If you specify <code>SERVICE_MANAGED</code> on AWS Grafana console, Amazon
  ...
  /// <code>SERVICE_MANAGED</code> will not create the IAM role for you.
  ///
  /// If you specify <code>CUSTOMER_MANAGED</code>, you will manage those roles
  /// and permissions yourself. If you are creating this workspace in a member
  /// account of an organization that is not a delegated administrator account,
  ...
  /// have a role that you want to use, specify it here. The permission type
  /// should be set to <code>CUSTOMER_MANAGED</code>.
  Future<CreateWorkspaceResponse> createWorkspace({
    ...
    ArgumentError.checkNotNull(accountAccessType, 'accountAccessType');
  ...
  ///
  /// Valid Values: <code>VIEWER</code> | <code>EDITOR</code> |
  /// <code>ADMIN</code>
  ///
  ...
  Future<CreateWorkspaceApiKeyResponse> createWorkspaceApiKey({
    ...
    ArgumentError.checkNotNull(keyRole, 'keyRole');
    ArgumentError.checkNotNull(secondsToLive, 'secondsToLive');
    _s.validateNumRange(
      'secondsToLive',
      secondsToLive,
      1,
  ...
  /// of Amazon Web Services SSO users are returned. If you specify
  /// <code>SSO_GROUP</code>, only the permissions of Amazon Web Services SSO
  /// groups are returned.
  ...
  /// SAML or Amazon Web Services SSO, use <a
  ...
  ///
  /// Parameter [permissionType] :
  /// If you specify <code>Service Managed</code>, Amazon Managed Grafana
  ...
  /// in other Amazon Web Services accounts in the organization, you must choose
  /// <code>CUSTOMER_MANAGED</code>.
  ///
  /// For more information, see <a
  /// href="https://docs.aws.amazon.com/grafana/latest/userguide/AMG-manage-permissions.html">Amazon
  ...
  /// and you specify some Amazon Web Services resources in
  /// <code>workspaceDataSources</code> or
  /// <code>workspaceNotificationDestinations</code>, a new IAM role with the
...
extension on AccountAccessType {
  String toValue() {
    switch (this) {
...
extension on AuthenticationProviderTypes {
  String toValue() {
    switch (this) {
...
extension on NotificationDestinationType {
  String toValue() {
    switch (this) {
...
/// <code>Admin</code> or <code>Editor</code> role that they have.
class PermissionEntry {
  /// Specifies whether the user or group has the <code>Admin</code> or
  /// <code>Editor</code> role.
  final Role role;
...
extension on SamlConfigurationStatus {
  String toValue() {
    switch (this) {
...
class WorkspaceDescription {
  ...
  /// If this is <code>Service Managed</code>, Amazon Managed Grafana
  ...
  /// channels.
  ///
  /// If this is <code>CUSTOMER_MANAGED</code>, you manage those roles and
  /// permissions yourself. If you are creating this workspace in a member account
  ...
  /// Web Services accounts in the organization, you must choose
  /// <code>CUSTOMER_MANAGED</code>.
  ///
  /// For more information, see <a
  /// href="https://docs.aws.amazon.com/grafana/latest/userguide/AMG-manage-permissions.html">Amazon
