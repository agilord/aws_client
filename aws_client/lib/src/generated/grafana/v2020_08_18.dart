...
import 'v2020_08_18.endpoints.dart' as _endpoints;
...
class Grafana {
  ...
  /// Valid values are <code>IPv4</code> and <code>DualStack</code>. For more
  /// information about IP address types, see <a
  ...
  /// one workspace, use <a
  /// href="https://docs.aws.amazon.com/grafana/latest/APIReference/API_DescribeWorkspace.html">DescribeWorkspace</a>.
  ///
  /// May throw [AccessDeniedException].
  /// May throw [InternalServerException].
  /// May throw [ThrottlingException].
...
class WorkspaceStatus {
  ...
  static const degraded = WorkspaceStatus._('DEGRADED');
...
class WorkspaceDescription {
  ...
  /// If the workspace is in the <code>DEGRADED</code> status, this field
  /// describes the reason the workspace is degraded.
  final String? degradedWorkspaceReason;
  ...
  /// values are <code>IPv4</code> and <code>DualStack</code>.
  ...
  factory WorkspaceDescription.fromJson(Map<String, dynamic> json) {
    return WorkspaceDescription(
      ...
      degradedWorkspaceReason: json['degradedWorkspaceReason'] as String?,
      description: json['description'] as String?,
  ...
  Map<String, dynamic> toJson() {
    ...
    final degradedWorkspaceReason = this.degradedWorkspaceReason;
    final description = this.description;
    ...
    return {
      ...
      if (accountAccessType != null)
        'accountAccessType': accountAccessType.value,
      if (degradedWorkspaceReason != null)
        'degradedWorkspaceReason': degradedWorkspaceReason,
      if (description != null) 'description': description,
