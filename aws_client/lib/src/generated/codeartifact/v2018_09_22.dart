...
import 'v2018_09_22.endpoints.dart' as _endpoints;
...
class PackageDependency {
  ...
  /// instead this is extracted from the <code><parent></code> element if one is
...
class EndpointType {
  ...
  static const values = [dualstack, ipv4];
