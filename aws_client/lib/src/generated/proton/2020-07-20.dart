...
class Proton {
  ...
  Future<CancelServiceInstanceDeploymentOutput>
    ...
    ArgumentError.checkNotNull(serviceInstanceName, 'serviceInstanceName');
  ...
  Future<CreateComponentOutput> createComponent({
    ...
    ArgumentError.checkNotNull(templateFile, 'templateFile');
    final headers = <String, String>{
      'Content-Type': 'application/x-amz-json-1.0',
  ...
  Future<CreateEnvironmentOutput> createEnvironment({
    ...
    ArgumentError.checkNotNull(templateMajorVersion, 'templateMajorVersion');
  ...
  Future<CreateEnvironmentAccountConnectionOutput>
    ...
    ArgumentError.checkNotNull(environmentName, 'environmentName');
    ArgumentError.checkNotNull(managementAccountId, 'managementAccountId');
  ...
  /// up repository connection</a> in the <i>Proton Administrator Guide</i> and
  /// <a
  /// href="https://docs.aws.amazon.com/proton/latest/userguide/proton-setup.html#setup-repo-connection">Setting
  /// up with Proton</a> in the <i>Proton User Guide</i>. <i>Don't</i> include
  ...
  Future<CreateTemplateSyncConfigOutput> createTemplateSyncConfig({
    ...
    ArgumentError.checkNotNull(branch, 'branch');
    ArgumentError.checkNotNull(repositoryName, 'repositoryName');
    ArgumentError.checkNotNull(repositoryProvider, 'repositoryProvider');
    ArgumentError.checkNotNull(templateName, 'templateName');
  ...
  Future<DeleteEnvironmentTemplateVersionOutput>
    ...
    ArgumentError.checkNotNull(majorVersion, 'majorVersion');
  ...
  Future<GetTemplateSyncStatusOutput> getTemplateSyncStatus({
    ...
    ArgumentError.checkNotNull(templateName, 'templateName');
    ArgumentError.checkNotNull(templateType, 'templateType');
    ArgumentError.checkNotNull(templateVersion, 'templateVersion');
    final headers = <String, String>{
      'Content-Type': 'application/x-amz-json-1.0',
  ...
  Future<ListEnvironmentAccountConnectionsOutput>
    ...
    ArgumentError.checkNotNull(requestedBy, 'requestedBy');
    _s.validateNumRange(
      'maxResults',
      maxResults,
      1,
  ...
  /// List tags for a resource. For more information, see <i>Proton resources
  ...
  Future<void> notifyResourceDeploymentStatusChange({
    required String resourceArn,
    required ResourceDeploymentStatus status,
    String? deploymentId,
    List<Output>? outputs,
  ...
  /// For more information, see <i>Edit a service</i> in the <a
...
class AccountSettings {
  ...
  /// provisioning. Required it if you have environments configured for
  /// self-managed provisioning with services that include pipelines.
...
class CompatibleEnvironmentTemplateInput {
  ...
  factory CompatibleEnvironmentTemplateInput.fromJson(
      Map<String, dynamic> json) {
...
extension on ComponentDeploymentUpdateType {
  String toValue() {
    switch (this) {
...
extension on DeploymentUpdateType {
  String toValue() {
    switch (this) {
...
extension on EnvironmentAccountConnectionRequesterAccountType {
  String toValue() {
    switch (this) {
...
extension on EnvironmentAccountConnectionStatus {
  String toValue() {
    switch (this) {
...
class EnvironmentTemplateFilter {
  ...
  factory EnvironmentTemplateFilter.fromJson(Map<String, dynamic> json) {
...
extension on ProvisionedResourceEngine {
  String toValue() {
    switch (this) {
...
class RepositoryBranchInput {
  ...
  factory RepositoryBranchInput.fromJson(Map<String, dynamic> json) {
...
extension on RepositoryProvider {
  String toValue() {
    switch (this) {
...
extension on RepositorySyncStatus {
  String toValue() {
    switch (this) {
...
extension on ResourceDeploymentStatus {
  String toValue() {
    switch (this) {
...
extension on ResourceSyncStatus {
  String toValue() {
    switch (this) {
...
class S3ObjectSource {
  ...
  factory S3ObjectSource.fromJson(Map<String, dynamic> json) {
...
class Service {
  ...
  /// information, see <a
  /// href="https://docs.aws.amazon.com/proton/latest/adminguide/setting-up-for-service.html#setting-up-vcontrol">Set
  /// up a repository connection</a> in the <i>Proton Administrator Guide</i> and
  /// <a
  /// href="https://docs.aws.amazon.com/proton/latest/userguide/proton-setup.html#setup-repo-connection">Setting
...
extension on ServiceTemplateSupportedComponentSourceType {
  String toValue() {
    switch (this) {
...
class TemplateVersionSourceInput {
  ...
  factory TemplateVersionSourceInput.fromJson(Map<String, dynamic> json) {
    return TemplateVersionSourceInput(
      s3: json['s3'] != null
          ? S3ObjectSource.fromJson(json['s3'] as Map<String, dynamic>)
          : null,
    );
  }
...
extension on TemplateVersionStatus {
  String toValue() {
    switch (this) {
