...
class RedshiftServerless {
  ...
  Future<ConvertRecoveryPointToSnapshotResponse>
    ...
    ArgumentError.checkNotNull(recoveryPointId, 'recoveryPointId');
  ...
  Future<CreateEndpointAccessResponse> createEndpointAccess({
    ...
    ArgumentError.checkNotNull(workgroupName, 'workgroupName');
    final headers = <String, String>{
      'Content-Type': 'application/x-amz-json-1.1',
  ...
  Future<CreateUsageLimitResponse> createUsageLimit({
    ...
    ArgumentError.checkNotNull(usageType, 'usageType');
    final headers = <String, String>{
      'Content-Type': 'application/x-amz-json-1.1',
  ...
  /// seconds (60 minutes).
  /// <pre><code> &lt;p&gt; The Identity and Access Management (IAM) user or
  /// role that runs GetCredentials must have an IAM policy attached that allows
  ...
  /// <code>nextToken</code> in subsequent <code>ListEndpointAccess</code>
  ...
  /// <code>nextToken</code>, you can include the returned
  /// <code>nextToken</code> in subsequent <code>ListNamespaces</code>
  /// operations, which returns results in the next page.
  ...
  /// <code>nextToken</code>, you can include the returned
  /// <code>nextToken</code> in subsequent <code>ListRecoveryPoints</code>
  /// operations, which returns results in the next page.
  ///
  /// Parameter [startTime] :
  ...
  /// <code>nextToken</code>, you can include the returned
  /// <code>nextToken</code> in subsequent <code>ListUsageLimits</code>
  /// operations, which returns results in the next page.
  ///
  /// Parameter [resourceArn] :
  ...
  /// options are <code>datestyle</code>,
  /// <code>enable_user_activity_logging</code>, <code>query_group</code>,
  /// <code>search_path</code>, and <code>max_query_execution_time</code>.
  ///
  /// Parameter [enhancedVpcRouting] :
...
extension on UsageLimitUsageType {
  String toValue() {
    switch (this) {
