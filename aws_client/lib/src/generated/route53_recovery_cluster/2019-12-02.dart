...
class Route53RecoveryCluster {
  ...
  Future<void> updateRoutingControlState({
    ...
    ArgumentError.checkNotNull(routingControlArn, 'routingControlArn');
    ArgumentError.checkNotNull(routingControlState, 'routingControlState');
    final headers = <String, String>{
      'Content-Type': 'application/x-amz-json-1.0',
...
extension on RoutingControlState {
  String toValue() {
    switch (this) {
...
class UpdateRoutingControlStateEntry {
  ...
  factory UpdateRoutingControlStateEntry.fromJson(Map<String, dynamic> json) {
