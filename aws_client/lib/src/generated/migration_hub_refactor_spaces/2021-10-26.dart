...
/// <pre><code> &lt;p&gt;This API reference provides descriptions, syntax, and
/// other details about each of the actions and data types for Amazon Web
/// Services Migration Hub Refactor Spaces (Refactor Spaces). The topic for each
/// action shows the API request parameters and the response. Alternatively, you
/// can use one of the Amazon Web Services SDKs to access an API that is
/// tailored to the programming language or platform that you're using. For more
/// information, see &lt;a
/// href=&quot;https://aws.amazon.com/tools/#SDKs&quot;&gt;Amazon Web Services
/// SDKs&lt;/a&gt;.&lt;/p&gt; &lt;p&gt;To share Refactor Spaces environments
/// with other Amazon Web Services accounts or with Organizations and their OUs,
/// use Resource Access Manager's &lt;code&gt;CreateResourceShare&lt;/code&gt;
/// API. See &lt;a
...
class MigrationHubRefactorSpaces {
  ...
  Future<CreateApplicationResponse> createApplication({
    ...
    ArgumentError.checkNotNull(environmentIdentifier, 'environmentIdentifier');
    ArgumentError.checkNotNull(name, 'name');
    ArgumentError.checkNotNull(proxyType, 'proxyType');
  ...
  Future<CreateEnvironmentResponse> createEnvironment({
    ...
    ArgumentError.checkNotNull(name, 'name');
    ArgumentError.checkNotNull(networkFabricType, 'networkFabricType');
    final $payload = <String, dynamic>{
      'Name': name,
  ...
  /// Lambda resources are provisioned. If the Lambda state is
  /// <code>Failed</code>, then the route creation fails. For more information,
  /// see the <a
  ...
  /// and the target group health check is run. The
  /// <code>HealthCheckProtocol</code>, <code>HealthCheckPort</code>, and
  /// <code>HealthCheckPath</code> are the same protocol, port, and path
  /// specified in the URL or health URL, if used. All other settings use the
  /// default values, as described in <a
  /// href="https://docs.aws.amazon.com/elasticloadbalancing/latest/application/target-group-health-checks.html">Health
  /// checks for your target groups</a>. The health check is considered
  ...
  Future<CreateRouteResponse> createRoute({
    ...
    ArgumentError.checkNotNull(environmentIdentifier, 'environmentIdentifier');
    ArgumentError.checkNotNull(routeType, 'routeType');
    ArgumentError.checkNotNull(serviceIdentifier, 'serviceIdentifier');
    final $payload = <String, dynamic>{
  ...
  Future<DeleteRouteResponse> deleteRoute({
    ...
    ArgumentError.checkNotNull(applicationIdentifier, 'applicationIdentifier');
    ArgumentError.checkNotNull(environmentIdentifier, 'environmentIdentifier');
    ArgumentError.checkNotNull(routeIdentifier, 'routeIdentifier');
    final response = await _protocol.send(
      payload: null,
      method: 'DELETE',
      requestUri:
  ...
  Future<UpdateRouteResponse> updateRoute({
    ...
    ArgumentError.checkNotNull(activationState, 'activationState');
    ArgumentError.checkNotNull(applicationIdentifier, 'applicationIdentifier');
    ArgumentError.checkNotNull(environmentIdentifier, 'environmentIdentifier');
    ArgumentError.checkNotNull(routeIdentifier, 'routeIdentifier');
    final $payload = <String, dynamic>{
...
extension on ApiGatewayEndpointType {
  String toValue() {
    switch (this) {
...
class DefaultRouteInput {
  ...
  factory DefaultRouteInput.fromJson(Map<String, dynamic> json) {
...
extension on ErrorResourceType {
  String toValue() {
    switch (this) {
...
extension on NetworkFabricType {
  String toValue() {
    switch (this) {
...
extension on RouteActivationState {
  String toValue() {
    switch (this) {
...
extension on ServiceEndpointType {
  String toValue() {
    switch (this) {
