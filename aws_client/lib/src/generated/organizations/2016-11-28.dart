...
class Organizations {
  ...
  /// <code>CloseAccount</code> operates asynchronously, it can return a
  ...
  /// <ul>
  /// <li>
  /// You can only close 10% of active member accounts within a rolling 30 day
  /// period. This quota is not bound by a calendar month, but starts when you
  /// close an account. Within 30 days of that initial account closure, you
  /// can't exceed the 10% account closure limit.
  /// </li>
  /// <li>
