...
import 'v2018_05_23.endpoints.dart' as _endpoints;
...
class KinesisAnalyticsV2 {
  ...
  /// <a>ListApplicationOperations</a> operation.
  /// <note>
  ...
  /// <a>DescribeApplicationOperation</a> operation.
  /// <note>
  /// This operation is supported only for Managed Service for Apache Flink.
  /// </note>
  ///
...
class DescribeApplicationOperationResponse {
  ...
  Map<String, dynamic> toJson() {
    final applicationOperationInfoDetails =
        this.applicationOperationInfoDetails;
    return {
...
class ListApplicationOperationsResponse {
  ...
  Map<String, dynamic> toJson() {
    final applicationOperationInfoList = this.applicationOperationInfoList;
...
class ApplicationDetail {
  ...
  Map<String, dynamic> toJson() {
    ...
    final applicationVersionCreateTimestamp =
        this.applicationVersionCreateTimestamp;
    ...
    return {
      ...
      if (applicationMaintenanceConfigurationDescription != null)
        'ApplicationMaintenanceConfigurationDescription':
            applicationMaintenanceConfigurationDescription,
      if (applicationMode != null) 'ApplicationMode': applicationMode.value,
      if (applicationVersionCreateTimestamp != null)
        'ApplicationVersionCreateTimestamp':
            unixTimestampToJson(applicationVersionCreateTimestamp),
...
class RuntimeEnvironment {
  ...
  static const flink_2_2 = RuntimeEnvironment._('FLINK-2_2');
...
class ApplicationConfigurationDescription {
  ...
  final ApplicationEncryptionConfigurationDescription?
  ...
  ApplicationConfigurationDescription({
    ...
    this.applicationEncryptionConfigurationDescription,
    ...
    return ApplicationConfigurationDescription(
      applicationCodeConfigurationDescription:
          json['ApplicationCodeConfigurationDescription'] != null
              ...
              : null,
      applicationEncryptionConfigurationDescription:
          json['ApplicationEncryptionConfigurationDescription'] != null
              ? ApplicationEncryptionConfigurationDescription.fromJson(
                  json['ApplicationEncryptionConfigurationDescription']
                      as Map<String, dynamic>)
              : null,
      applicationSnapshotConfigurationDescription:
  ...
  Map<String, dynamic> toJson() {
    ...
    return {
      if (applicationCodeConfigurationDescription != null)
        'ApplicationCodeConfigurationDescription':
            applicationCodeConfigurationDescription,
      if (applicationEncryptionConfigurationDescription != null)
        'ApplicationEncryptionConfigurationDescription':
            applicationEncryptionConfigurationDescription,
      if (applicationSnapshotConfigurationDescription != null)
        'ApplicationSnapshotConfigurationDescription':
            applicationSnapshotConfigurationDescription,
      if (applicationSystemRollbackConfigurationDescription != null)
        'ApplicationSystemRollbackConfigurationDescription':
            applicationSystemRollbackConfigurationDescription,
...
class FlinkApplicationConfigurationDescription {
  ...
  /// see <a
  /// href="https://nightlies.apache.org/flink/flink-docs-release-2.2/internals/job_scheduling.html">Jobs
...
class ApplicationEncryptionConfigurationDescription {
  ...
  factory ApplicationEncryptionConfigurationDescription.fromJson(
      Map<String, dynamic> json) {
    return ApplicationEncryptionConfigurationDescription(
...
class ParallelismConfigurationDescription {
  ...
  /// for the application. The maximum KPUs for an application is 64 by default,
...
class ApplicationConfigurationUpdate {
  ...
  final ApplicationEncryptionConfigurationUpdate?
  ...
  ApplicationConfigurationUpdate({
    ...
    this.applicationEncryptionConfigurationUpdate,
    ...
    return {
      if (applicationCodeConfigurationUpdate != null)
        'ApplicationCodeConfigurationUpdate':
            applicationCodeConfigurationUpdate,
      if (applicationEncryptionConfigurationUpdate != null)
        'ApplicationEncryptionConfigurationUpdate':
            applicationEncryptionConfigurationUpdate,
...
class ApplicationEncryptionConfigurationUpdate {
  ...
  /// encryption at rest.
  final String? keyIdUpdate;

  ApplicationEncryptionConfigurationUpdate({
    required this.keyTypeUpdate,
    this.keyIdUpdate,
  });

  Map<String, dynamic> toJson() {
    final keyTypeUpdate = this.keyTypeUpdate;
    final keyIdUpdate = this.keyIdUpdate;
    return {
      'KeyTypeUpdate': keyTypeUpdate.value,
      if (keyIdUpdate != null) 'KeyIdUpdate': keyIdUpdate,
    };
  }
}
...
class ApplicationOperationInfoDetails {
  ...
  Map<String, dynamic> toJson() {
    ...
    final operationStatus = this.operationStatus;
    final startTime = this.startTime;
    final applicationVersionChangeDetails =
        this.applicationVersionChangeDetails;
    final operationFailureDetails = this.operationFailureDetails;
    return {
      'EndTime': unixTimestampToJson(endTime),
      'Operation': operation,
      'OperationStatus': operationStatus.value,
      'StartTime': unixTimestampToJson(startTime),
      if (applicationVersionChangeDetails != null)
        'ApplicationVersionChangeDetails': applicationVersionChangeDetails,
      if (operationFailureDetails != null)
...
class ApplicationVersionChangeDetails {
  ...
  Map<String, dynamic> toJson() {
    final applicationVersionUpdatedFrom = this.applicationVersionUpdatedFrom;
    final applicationVersionUpdatedTo = this.applicationVersionUpdatedTo;
    return {
      'ApplicationVersionUpdatedFrom': applicationVersionUpdatedFrom,
      'ApplicationVersionUpdatedTo': applicationVersionUpdatedTo,
    };
  }
}
...
class OperationFailureDetails {
  ...
  Map<String, dynamic> toJson() {
    ...
    final rollbackOperationId = this.rollbackOperationId;
    return {
      if (errorInfo != null) 'ErrorInfo': errorInfo,
      if (rollbackOperationId != null)
...
class ApplicationConfiguration {
  ...
  final ApplicationEncryptionConfiguration? applicationEncryptionConfiguration;
  ...
  Map<String, dynamic> toJson() {
    ...
    final applicationEncryptionConfiguration =
        this.applicationEncryptionConfiguration;
...
class ParallelismConfiguration {
  ...
  /// maximum parallelism, which is <code>ParalellismPerKPU</code> times the
  /// maximum KPUs for the application. The maximum KPUs for an application is 64
  /// by default, and can be increased by requesting a limit increase. If
  /// application load is reduced, the service can reduce the
  /// <code>CurrentParallelism</code> value down to the <code>Parallelism</code>
  /// setting.
