...
import 'v2018_07_27.endpoints.dart' as _endpoints;
...
class SetTimerAction {
  ...
  /// input values (<code>$input.<input-name>.<path-to-datum></code>) as the
...
class Payload {
  ...
  /// (<code>$input.<input-name>.<path-to-datum></code>), string concatenations,
  /// and quoted strings that contain <code>${}</code> as the content. The
