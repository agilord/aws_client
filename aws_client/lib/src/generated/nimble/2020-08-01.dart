...
class NimbleStudio {
  ...
  Future<CreateLaunchProfileResponse> createLaunchProfile({
    ...
    ArgumentError.checkNotNull(ec2SubnetIds, 'ec2SubnetIds');
    ArgumentError.checkNotNull(
        launchProfileProtocolVersions, 'launchProfileProtocolVersions');
    ArgumentError.checkNotNull(name, 'name');
    ArgumentError.checkNotNull(streamConfiguration, 'streamConfiguration');
    ArgumentError.checkNotNull(studioComponentIds, 'studioComponentIds');
    ArgumentError.checkNotNull(studioId, 'studioId');
    final headers = <String, String>{
      if (clientToken != null) 'X-Amz-Client-Token': clientToken.toString(),
    };
  ...
  Future<CreateStudioResponse> createStudio({
    ...
    ArgumentError.checkNotNull(adminRoleArn, 'adminRoleArn');
    ArgumentError.checkNotNull(displayName, 'displayName');
    ArgumentError.checkNotNull(studioName, 'studioName');
    ArgumentError.checkNotNull(userRoleArn, 'userRoleArn');
    final headers = <String, String>{
      if (clientToken != null) 'X-Amz-Client-Token': clientToken.toString(),
    };
    final $payload = <String, dynamic>{
  ...
  Future<DeleteLaunchProfileResponse> deleteLaunchProfile({
    ...
    ArgumentError.checkNotNull(launchProfileId, 'launchProfileId');
    ArgumentError.checkNotNull(studioId, 'studioId');
    final headers = <String, String>{
      if (clientToken != null) 'X-Amz-Client-Token': clientToken.toString(),
    };
  ...
  Future<DeleteStreamingImageResponse> deleteStreamingImage({
    ...
    ArgumentError.checkNotNull(streamingImageId, 'streamingImageId');
    ArgumentError.checkNotNull(studioId, 'studioId');
    final headers = <String, String>{
      if (clientToken != null) 'X-Amz-Client-Token': clientToken.toString(),
    };
  ...
  Future<DeleteStudioComponentResponse> deleteStudioComponent({
    ...
    ArgumentError.checkNotNull(studioComponentId, 'studioComponentId');
    ArgumentError.checkNotNull(studioId, 'studioId');
    final headers = <String, String>{
      if (clientToken != null) 'X-Amz-Client-Token': clientToken.toString(),
    };
  ...
  Future<GetEulaResponse> getEula({
    ...
    ArgumentError.checkNotNull(eulaId, 'eulaId');
    final response = await _protocol.send(
      payload: null,
      method: 'GET',
  ...
  Future<GetLaunchProfileInitializationResponse>
    ...
    ArgumentError.checkNotNull(
        launchProfileProtocolVersions, 'launchProfileProtocolVersions');
    ArgumentError.checkNotNull(launchPurpose, 'launchPurpose');
  ...
  Future<void> putLaunchProfileMembers({
    ...
    ArgumentError.checkNotNull(launchProfileId, 'launchProfileId');
    ArgumentError.checkNotNull(members, 'members');
    ArgumentError.checkNotNull(studioId, 'studioId');
    final headers = <String, String>{
      if (clientToken != null) 'X-Amz-Client-Token': clientToken.toString(),
    };
...
/// Machine Images (AMIs).
/// <pre><code> &lt;p&gt;Studio administrators create launch profiles in the
/// Nimble Studio console. Artists can use their launch profiles to launch an
/// instance from the Nimble Studio portal. Each user’s launch profile defines
/// how they can launch a streaming session. By default, studio admins can use
/// all launch profiles.&lt;/p&gt; </code></pre>
class LaunchProfile {
...
/// needing to write or maintain complex IAM policies. A launch profile member
...
extension on LaunchProfilePersona {
  String toValue() {
    switch (this) {
...
extension on LaunchProfilePlatform {
  String toValue() {
    switch (this) {
...
extension on LaunchProfileState {
  String toValue() {
    switch (this) {
...
extension on LaunchProfileStatusCode {
  String toValue() {
    switch (this) {
...
extension on LaunchProfileValidationState {
  String toValue() {
    switch (this) {
...
extension on LaunchProfileValidationStatusCode {
  String toValue() {
    switch (this) {
...
extension on LaunchProfileValidationType {
  String toValue() {
    switch (this) {
...
class NewLaunchProfileMember {
  ...
  factory NewLaunchProfileMember.fromJson(Map<String, dynamic> json) {
...
class NewStudioMember {
  ...
  factory NewStudioMember.fromJson(Map<String, dynamic> json) {
...
class StreamConfiguration {
  ...
  /// value is 5760.
  ///
  /// If the value is missing or set to 0, your sessions can’t be stopped. If you
  /// then call <code>StopStreamingSession</code>, the session fails. If the time
  ...
  /// can call <code>StopStreamingSession</code> to stop sessions in the READY
...
class StreamConfigurationCreate {
  ...
  factory StreamConfigurationCreate.fromJson(Map<String, dynamic> json) {
...
extension on StreamingClipboardMode {
  String toValue() {
    switch (this) {
...
extension on StreamingImageEncryptionConfigurationKeyType {
  String toValue() {
    switch (this) {
...
extension on StreamingImageState {
  String toValue() {
    switch (this) {
...
extension on StreamingImageStatusCode {
  String toValue() {
    switch (this) {
...
extension on StreamingInstanceType {
  String toValue() {
    switch (this) {
...
extension on StreamingSessionState {
  String toValue() {
    switch (this) {
...
extension on StreamingSessionStatusCode {
  String toValue() {
    switch (this) {
...
extension on StreamingSessionStorageMode {
  String toValue() {
    switch (this) {
...
extension on StreamingSessionStreamState {
  String toValue() {
    switch (this) {
...
extension on StreamingSessionStreamStatusCode {
  String toValue() {
    switch (this) {
...
/// to the Nimble Studio portal via Amazon Web Services SSO and your identity
/// source.
///
/// The user role must have the AmazonNimbleStudio-StudioUser managed policy
/// attached for the portal to function properly.
...
extension on StudioComponentInitializationScriptRunContext {
  String toValue() {
    switch (this) {
...
/// will equal "CREATE_IN_PROGRESS", "UPDATE_IN_PROGRESS", or
/// "DELETE_IN_PROGRESS"
///
...
/// why creation failed. The resource in this state will automatically be
/// deleted from your account after a period of time.
///
/// If updating the resource fails, the state will change to `UPDATE_FAILED`.
/// The resource StatusCode and StatusMessage will provide more information of
/// why the update failed. The resource will be returned to the state it was in
/// when the update request was invoked.
///
...
/// futher. It will be removed from your account after a period of time.
...
extension on StudioComponentState {
  String toValue() {
    switch (this) {
...
extension on StudioComponentStatusCode {
  String toValue() {
    switch (this) {
...
extension on StudioComponentSubtype {
  String toValue() {
    switch (this) {
...
extension on StudioComponentType {
  String toValue() {
    switch (this) {
...
extension on StudioEncryptionConfigurationKeyType {
  String toValue() {
    switch (this) {
...
/// given access to the studio's AWS SSO application and are given access to log
/// in to the Nimble Studio portal. These users have the permissions provided by
/// the studio's user IAM role and do not appear in the studio membership
