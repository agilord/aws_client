...
class ConnectCampaign {
  ...
  Future<CreateCampaignResponse> createCampaign({
    ...
    ArgumentError.checkNotNull(connectInstanceId, 'connectInstanceId');
    ArgumentError.checkNotNull(dialerConfig, 'dialerConfig');
    ArgumentError.checkNotNull(name, 'name');
    ArgumentError.checkNotNull(outboundCallConfig, 'outboundCallConfig');
  ...
  Future<GetCampaignStateBatchResponse> getCampaignStateBatch({
    ...
    ArgumentError.checkNotNull(campaignIds, 'campaignIds');
    final $payload = <String, dynamic>{
  ...
  Future<PutDialRequestBatchResponse> putDialRequestBatch({
    ...
    ArgumentError.checkNotNull(dialRequests, 'dialRequests');
    ArgumentError.checkNotNull(id, 'id');
    final $payload = <String, dynamic>{
...
class CampaignFilters {
  ...
  factory CampaignFilters.fromJson(Map<String, dynamic> json) {
    return CampaignFilters(
      instanceIdFilter: json['instanceIdFilter'] != null
          ? InstanceIdFilter.fromJson(
              json['instanceIdFilter'] as Map<String, dynamic>)
          : null,
    );
  }
...
class DialRequest {
  ...
  factory DialRequest.fromJson(Map<String, dynamic> json) {
    return DialRequest(
      attributes: (json['attributes'] as Map<String, dynamic>)
          .map((k, e) => MapEntry(k, e as String)),
      clientToken: json['clientToken'] as String,
      expirationTime:
          nonNullableTimeStampFromJson(json['expirationTime'] as Object),
...
extension on GetCampaignStateBatchFailureCode {
  String toValue() {
    switch (this) {
...
class InstanceIdFilter {
  ...
  factory InstanceIdFilter.fromJson(Map<String, dynamic> json) {
    return InstanceIdFilter(
      operator: (json['operator'] as String).toInstanceIdFilterOperator(),
...
extension on InstanceIdFilterOperator {
  String toValue() {
    switch (this) {
...
extension on InstanceOnboardingJobFailureCode {
  String toValue() {
    switch (this) {
...
extension on InstanceOnboardingJobStatusCode {
  String toValue() {
    switch (this) {
