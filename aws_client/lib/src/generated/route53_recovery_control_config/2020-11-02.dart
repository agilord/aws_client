...
class Route53RecoveryControlConfig {
  ...
  Future<CreateControlPanelResponse> createControlPanel({
    ...
    ArgumentError.checkNotNull(controlPanelName, 'controlPanelName');
    final $payload = <String, dynamic>{
  ...
  Future<CreateRoutingControlResponse> createRoutingControl({
    ...
    ArgumentError.checkNotNull(clusterArn, 'clusterArn');
    ArgumentError.checkNotNull(routingControlName, 'routingControlName');
    final $payload = <String, dynamic>{
      'ClusterArn': clusterArn,
  ...
  Future<void> deleteControlPanel({
    ...
    ArgumentError.checkNotNull(controlPanelArn, 'controlPanelArn');
    final response = await _protocol.send(
      payload: null,
      method: 'DELETE',
  ...
  Future<void> deleteRoutingControl({
    ...
    ArgumentError.checkNotNull(routingControlArn, 'routingControlArn');
    final response = await _protocol.send(
      payload: null,
      method: 'DELETE',
  ...
  Future<void> deleteSafetyRule({
    ...
    ArgumentError.checkNotNull(safetyRuleArn, 'safetyRuleArn');
    final response = await _protocol.send(
      payload: null,
      method: 'DELETE',
...
class AssertionRuleUpdate {
  ...
  factory AssertionRuleUpdate.fromJson(Map<String, dynamic> json) {
...
class GatingRule {
  ...
  /// automated fail over, for example.
...
class GatingRuleUpdate {
  ...
  factory GatingRuleUpdate.fromJson(Map<String, dynamic> json) {
...
class NewAssertionRule {
  ...
  factory NewAssertionRule.fromJson(Map<String, dynamic> json) {
...
class NewGatingRule {
  ...
  factory NewGatingRule.fromJson(Map<String, dynamic> json) {
