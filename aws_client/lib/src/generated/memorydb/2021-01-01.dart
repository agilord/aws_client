...
class MemoryDB {
  ...
  Future<BatchUpdateClusterResponse> batchUpdateCluster({
    ...
    ArgumentError.checkNotNull(clusterNames, 'clusterNames');
  ...
  Future<CreateACLResponse> createACL({
    ...
    ArgumentError.checkNotNull(aCLName, 'aCLName');
    final headers = <String, String>{
      'Content-Type': 'application/x-amz-json-1.1',
  ...
  Future<CreateUserResponse> createUser({
    ...
    ArgumentError.checkNotNull(authenticationMode, 'authenticationMode');
  ...
  Future<FailoverShardResponse> failoverShard({
    ...
    ArgumentError.checkNotNull(clusterName, 'clusterName');
    ArgumentError.checkNotNull(shardName, 'shardName');
    final headers = <String, String>{
      'Content-Type': 'application/x-amz-json-1.1',
...
class AuthenticationMode {
  ...
  factory AuthenticationMode.fromJson(Map<String, dynamic> json) {
    return AuthenticationMode(
      passwords: (json['Passwords'] as List?)
          ?.whereNotNull()
          .map((e) => e as String)
          .toList(),
      type: (json['Type'] as String?)?.toInputAuthenticationType(),
    );
  }
...
extension on InputAuthenticationType {
  String toValue() {
    switch (this) {
...
class ReplicaConfigurationRequest {
  ...
  factory ReplicaConfigurationRequest.fromJson(Map<String, dynamic> json) {
...
class ServiceUpdateRequest {
  ...
  factory ServiceUpdateRequest.fromJson(Map<String, dynamic> json) {
    return ServiceUpdateRequest(
      serviceUpdateNameToApply: json['ServiceUpdateNameToApply'] as String?,
    );
  }
...
class ShardConfigurationRequest {
  ...
  factory ShardConfigurationRequest.fromJson(Map<String, dynamic> json) {
