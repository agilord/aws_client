...
class MainframeModernization {
  ...
  Future<CreateApplicationResponse> createApplication({
    ...
    ArgumentError.checkNotNull(engineType, 'engineType');
  ...
  Future<CreateDataSetImportTaskResponse> createDataSetImportTask({
    ...
    ArgumentError.checkNotNull(applicationId, 'applicationId');
    ArgumentError.checkNotNull(importConfig, 'importConfig');
    final $payload = <String, dynamic>{
  ...
  Future<CreateDeploymentResponse> createDeployment({
    ...
    ArgumentError.checkNotNull(applicationId, 'applicationId');
    ArgumentError.checkNotNull(applicationVersion, 'applicationVersion');
    _s.validateNumRange(
      'applicationVersion',
      applicationVersion,
      1,
  ...
  /// API removes the association of the application with the environment so you
  ...
  /// data sets into catalogs using <a
  ...
  Future<StartBatchJobResponse> startBatchJob({
    ...
    ArgumentError.checkNotNull(applicationId, 'applicationId');
    ArgumentError.checkNotNull(batchJobIdentifier, 'batchJobIdentifier');
    final $payload = <String, dynamic>{
  ...
  /// The default is false. Currently, Amazon Web Services Mainframe
...
extension on ApplicationDeploymentLifecycle {
  String toValue() {
    switch (this) {
...
extension on ApplicationLifecycle {
  String toValue() {
    switch (this) {
...
extension on ApplicationVersionLifecycle {
  String toValue() {
    switch (this) {
...
extension on BatchJobExecutionStatus {
  String toValue() {
    switch (this) {
...
class DataSet {
  ...
  factory DataSet.fromJson(Map<String, dynamic> json) {
    return DataSet(
      ...
      datasetOrg: DatasetOrgAttributes.fromJson(
          json['datasetOrg'] as Map<String, dynamic>),
      recordLength:
          RecordLength.fromJson(json['recordLength'] as Map<String, dynamic>),
...
class DataSetImportConfig {
  ...
  factory DataSetImportConfig.fromJson(Map<String, dynamic> json) {
    return DataSetImportConfig(
      dataSets: (json['dataSets'] as List?)
          ?.whereNotNull()
          .map((e) => DataSetImportItem.fromJson(e as Map<String, dynamic>))
          .toList(),
...
class DataSetImportItem {
  ...
  factory DataSetImportItem.fromJson(Map<String, dynamic> json) {
    return DataSetImportItem(
      dataSet: DataSet.fromJson(json['dataSet'] as Map<String, dynamic>),
      externalLocation: ExternalLocation.fromJson(
          json['externalLocation'] as Map<String, dynamic>),
    );
  }
...
extension on DataSetTaskLifecycle {
  String toValue() {
    switch (this) {
...
class DatasetOrgAttributes {
  ...
  factory DatasetOrgAttributes.fromJson(Map<String, dynamic> json) {
    return DatasetOrgAttributes(
      gdg: json['gdg'] != null
          ? GdgAttributes.fromJson(json['gdg'] as Map<String, dynamic>)
          : null,
      vsam: json['vsam'] != null
          ? VsamAttributes.fromJson(json['vsam'] as Map<String, dynamic>)
          : null,
    );
  }
...
extension on DeploymentLifecycle {
  String toValue() {
    switch (this) {
...
extension on EnvironmentLifecycle {
  String toValue() {
    switch (this) {
...
class ExternalLocation {
  ...
  factory ExternalLocation.fromJson(Map<String, dynamic> json) {
...
class GdgAttributes {
  ...
  factory GdgAttributes.fromJson(Map<String, dynamic> json) {
    return GdgAttributes(
...
class GetApplicationResponse {
  ...
  /// Modernization creates this listener on your behalf the first time you deploy
  /// an application.
...
class RecordLength {
  ...
  factory RecordLength.fromJson(Map<String, dynamic> json) {
    return RecordLength(
      max: json['max'] as int,
      min: json['min'] as int,
    );
...
class VsamAttributes {
  ...
  factory VsamAttributes.fromJson(Map<String, dynamic> json) {
    return VsamAttributes(
      format: json['format'] as String,
