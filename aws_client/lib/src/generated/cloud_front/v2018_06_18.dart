...
class CloudFront {
  ...
  Future<void> deleteCloudFrontOriginAccessIdentity2018_06_18({
    ...
    await _protocol.send(
      method: 'DELETE',
      requestUri:
          '/2018-06-18/origin-access-identity/cloudfront/${Uri.encodeComponent(id)}',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
  }
  ...
  Future<void> deleteFieldLevelEncryptionConfig2018_06_18({
    ...
    await _protocol.send(
      method: 'DELETE',
      requestUri:
          '/2018-06-18/field-level-encryption/${Uri.encodeComponent(id)}',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
  }
  ...
  Future<void> deleteFieldLevelEncryptionProfile2018_06_18({
    ...
    await _protocol.send(
      method: 'DELETE',
      requestUri:
          '/2018-06-18/field-level-encryption-profile/${Uri.encodeComponent(id)}',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
  }
  ...
  Future<void> deleteStreamingDistribution2018_06_18({
    ...
    await _protocol.send(
      method: 'DELETE',
      requestUri:
          '/2018-06-18/streaming-distribution/${Uri.encodeComponent(id)}',
      headers: headers,
      exceptionFnMap: _exceptionFns,
    );
  }
  ...
  Future<GetCloudFrontOriginAccessIdentityConfigResult>
    ...
    final $result = await _protocol.sendRaw(
      method: 'GET',
      requestUri:
          '/2018-06-18/origin-access-identity/cloudfront/${Uri.encodeComponent(id)}/config',
      exceptionFnMap: _exceptionFns,
    );
    final $elem = await _s.xmlFromResponse($result);
  ...
  Future<GetInvalidationResult> getInvalidation2018_06_18({
    ...
    final $result = await _protocol.sendRaw(
      method: 'GET',
      requestUri:
          '/2018-06-18/distribution/${Uri.encodeComponent(distributionId)}/invalidation/${Uri.encodeComponent(id)}',
      exceptionFnMap: _exceptionFns,
    );
    final $elem = await _s.xmlFromResponse($result);
